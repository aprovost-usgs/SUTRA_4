C     ITERATIVE MATRIX SOLVERS (SLAP) ............ SUTRA VERSION 4.0     SLAP...........100
C                                                                        SLAP...........200
C *** PURPOSE :                                                          SLAP...........300
...
C...........THE NEXT TWO LINES OF CODE INVOLVE BUG FIXES MADE DURING     SLAP........787800
C              INTEGRATION OF SLAP WITH SUTRA.  IN SUTRA 2.2, THE        SLAP........787900
C              ORIGINAL LINE OF CODE THAT READ                           SLAP........788000
C            CALL MSOLVE(N, R, Z, NELT, IA, JA, A, ISYM, RWORK, IWORK)   SLAP........788100
C              WAS REPLACED WITH THE FOLLOWING LINE:                     SLAP........788200
C            CALL MSOLVE(N, R, DZ, NELT, IA, JA, A, ISYM, RWORK, IWORK)  SLAP........788300
C              ALTHOUGH THIS WAS INCORRECT, IT DID NOT AFFECT SUTRA      SLAP........788400
C              MODEL RESULTS BECAUSE ITOL=2 WAS NOT USED. IN SUTRA 3.0,  SLAP........788500
C              THIS WAS CORRECTED BY RESTORING THAT LINE TO ITS ORIGINAL SLAP........788600
C              FORM AND ADDING A CALL TO MSOLVE TO SET DZ=Minv*B.        SLAP........788700
            CALL MSOLVE(N, R, Z, NELT, IA, JA, A, ISYM, RWORK, IWORK)    SLAP........788800
            CALL MSOLVE(N, B, DZ, NELT, IA, JA, A, ISYM, RWORK, IWORK)   SLAP........788900
            BNRM = DNRM2(N, DZ, 1)                                       SLAP........789000
         ENDIF                                                           SLAP........789100
         ERR = DNRM2(N, Z, 1)/BNRM                                       SLAP........789200
      ELSE IF( ITOL.EQ.11 ) THEN                                         SLAP........789300
C         err = ||x-TrueSolution||/||TrueSolution|| (2-Norms).           SLAP........789400
         IF(ITER .EQ. 0) SOLNRM = DNRM2(N, SOLN, 1)                      SLAP........789500
         DO 10 I = 1, N                                                  SLAP........789600
            DZ(I) = X(I) - SOLN(I)                                       SLAP........789700
 10      CONTINUE                                                        SLAP........789800
         ERR = DNRM2(N, DZ, 1)/SOLNRM                                    SLAP........789900
      ELSE                                                               SLAP........790000
C                                                                        SLAP........790100
C         If we get here ITOL is not one of the acceptable values.       SLAP........790200
         ERR = D1MACH(2)                                                 SLAP........790300
         IERR = 3                                                        SLAP........790400
      ENDIF                                                              SLAP........790500
C                                                                        SLAP........790600
      IF(IUNIT .NE. 0) THEN                                              SLAP........790700
         IF( ITER.EQ.0 ) THEN                                            SLAP........790800
C...........THE NEXT LINE OF CODE WAS MODIFIED DURING INTEGRATION        SLAP........790900
C              OF SLAP WITH SUTRA.  IT ORIGINALLY READ:                  SLAP........791000
C              WRITE(IUNIT,1000) N, ITOL                                 SLAP........791100
            WRITE(IUNIT,1000)                                            SLAP........791200
            WRITE(IUNIT,1010) ITER, ERR                                  SLAP........791300
         ELSE                                                            SLAP........791400
C...........THE NEXT LINE OF CODE WAS MODIFIED DURING INTEGRATION        SLAP........791500
C              OF SLAP WITH SUTRA.  IT ORIGINALLY READ:                  SLAP........791600
C              WRITE(IUNIT,1010) ITER, ERR, AK, BK                       SLAP........791700
            WRITE(IUNIT,1010) ITER, ERR                                  SLAP........791800
         ENDIF                                                           SLAP........791900
      ENDIF                                                              SLAP........792000
      IF(ERR .LE. TOL) ISDCG = 1                                         SLAP........792100
      RETURN                                                             SLAP........792200
C.....THE NEXT TWO LINES OF CODE REFLECT MODIFICATIONS MADE DURING       SLAP........792300
C        INTEGRATION OF SLAP WITH SUTRA.  THEY ORIGINALLY READ:          SLAP........792400
C        1000 FORMAT(' Preconditioned Conjugate Gradient for ',          SLAP........792500
C            $     'N, ITOL = ',I5, I5,                                  SLAP........792600
C            $     /' ITER','   Error Estimate','            Alpha',     SLAP........792700
C            $     '             Beta')                                  SLAP........792800
C        1010 FORMAT(1X,I4,1X,D16.7,1X,D16.7,1X,D16.7)                   SLAP........792900
1000  FORMAT(1X,6X,'Solver Iteration','   Error Estimate')               SLAP........793000
1010  FORMAT(1X,6X,I16,1X,1PE16.7)                                       SLAP........793100
C------------- LAST LINE OF ISDCG FOLLOWS ------------------------------ SLAP........793200
      END                                                                SLAP........793300
*DECK ISDGMR                                                             SLAP........793400
      INTEGER FUNCTION ISDGMR (N, B, X, XL, NELT, IA, JA, A, ISYM,       SLAP........793500
     +   MSOLVE, NMSL, ITOL, TOL, ITMAX, ITER, ERR, IUNIT, R, Z, DZ,     SLAP........793600
     +   RWORK, IWORK, RNRM, BNRM, SB, SX, JSCAL, KMP, LGMR, MAXL,       SLAP........793700
     +   MAXLP1, V, Q, SNORMW, PROD, R0NRM, HES, JPRE)                   SLAP........793800
C***BEGIN PROLOGUE  ISDGMR                                               SLAP........793900
C***SUBSIDIARY                                                           SLAP........794000
C***PURPOSE  Generalized Minimum Residual Stop Test.                     SLAP........794100
C            This routine calculates the stop test for the Generalized   SLAP........794200
C            Minimum RESidual (GMRES) iteration scheme.  It returns a    SLAP........794300
C            non-zero if the error estimate (the type of which is        SLAP........794400
C            determined by ITOL) is less than the user specified         SLAP........794500
C            tolerance TOL.                                              SLAP........794600
C***LIBRARY   SLATEC (SLAP)                                              SLAP........794700
C***CATEGORY  D2A4, D2B4                                                 SLAP........794800
C***TYPE      DOUBLE PRECISION (ISSGMR-S, ISDGMR-D)                      SLAP........794900
C***KEYWORDS  GMRES, LINEAR SYSTEM, SLAP, SPARSE, STOP TEST              SLAP........795000
C***AUTHOR  Brown, Peter, (LLNL), pnbrown@llnl.gov                       SLAP........795100
C           Hindmarsh, Alan, (LLNL), alanh@llnl.gov                      SLAP........795200
C           Seager, Mark K., (LLNL), seager@llnl.gov                     SLAP........795300
C             Lawrence Livermore National Laboratory                     SLAP........795400
C             PO Box 808, L-60                                           SLAP........795500
C             Livermore, CA 94550 (510) 423-3141                         SLAP........795600
C***DESCRIPTION                                                          SLAP........795700
C                                                                        SLAP........795800
C *Usage:                                                                SLAP........795900
C      INTEGER N, NELT, IA(NELT), JA(NELT), ISYM, NMSL, ITOL             SLAP........796000
C      INTEGER ITMAX, ITER, IUNIT, IWORK(USER DEFINED), JSCAL            SLAP........796100
C      INTEGER KMP, LGMR, MAXL, MAXLP1, JPRE                             SLAP........796200
C      DOUBLE PRECISION B(N), X(N), XL(MAXL), A(NELT), TOL, ERR,         SLAP........796300
C     $                 R(N), Z(N), DZ(N), RWORK(USER DEFINED),          SLAP........796400
C     $                 RNRM, BNRM, SB(N), SX(N), V(N,MAXLP1),           SLAP........796500
C     $                 Q(2*MAXL), SNORMW, PROD, R0NRM,                  SLAP........796600
C     $                 HES(MAXLP1,MAXL)                                 SLAP........796700
C      EXTERNAL MSOLVE                                                   SLAP........796800
C                                                                        SLAP........796900
C      IF (ISDGMR(N, B, X, XL, NELT, IA, JA, A, ISYM, MSOLVE,            SLAP........797000
C     $     NMSL, ITOL, TOL, ITMAX, ITER, ERR, IUNIT, R, Z, DZ,          SLAP........797100
C     $     RWORK, IWORK, RNRM, BNRM, SB, SX, JSCAL,                     SLAP........797200
C     $     KMP, LGMR, MAXL, MAXLP1, V, Q, SNORMW, PROD, R0NRM,          SLAP........797300
C     $     HES, JPRE) .NE. 0) THEN ITERATION DONE                       SLAP........797400
C                                                                        SLAP........797500
C *Arguments:                                                            SLAP........797600
C N      :IN       Integer.                                              SLAP........797700
C         Order of the Matrix.                                           SLAP........797800
C B      :IN       Double Precision B(N).                                SLAP........797900
C         Right-hand-side vector.                                        SLAP........798000
C X      :IN       Double Precision X(N).                                SLAP........798100
C         Approximate solution vector as of the last restart.            SLAP........798200
C XL     :OUT      Double Precision XL(N)                                SLAP........798300
C         An array of length N used to hold the approximate              SLAP........798400
C         solution as of the current iteration.  Only computed by        SLAP........798500
C         this routine when ITOL=11.                                     SLAP........798600
C NELT   :IN       Integer.                                              SLAP........798700
C         Number of Non-Zeros stored in A.                               SLAP........798800
C IA     :IN       Integer IA(NELT).                                     SLAP........798900
C JA     :IN       Integer JA(NELT).                                     SLAP........799000
C A      :IN       Double Precision A(NELT).                             SLAP........799100
C         These arrays contain the matrix data structure for A.          SLAP........799200
C         It could take any form.  See "Description", in the DGMRES,     SLAP........799300
C         DSLUGM and DSDGMR routines for more details.                   SLAP........799400
C ISYM   :IN       Integer.                                              SLAP........799500
C         Flag to indicate symmetric storage format.                     SLAP........799600
C         If ISYM=0, all non-zero entries of the matrix are stored.      SLAP........799700
C         If ISYM=1, the matrix is symmetric, and only the upper         SLAP........799800
C         or lower triangle of the matrix is stored.                     SLAP........799900
C MSOLVE :EXT      External.                                             SLAP........800000
C         Name of a routine which solves a linear system Mz = r for  z   SLAP........800100
C         given r with the preconditioning matrix M (M is supplied via   SLAP........800200
C         RWORK and IWORK arrays.  The name of the MSOLVE routine must   SLAP........800300
C         be declared external in the calling program.  The calling      SLAP........800400
C         sequence to MSOLVE is:                                         SLAP........800500
C             CALL MSOLVE(N, R, Z, NELT, IA, JA, A, ISYM, RWORK, IWORK)  SLAP........800600
C         Where N is the number of unknowns, R is the right-hand side    SLAP........800700
C         vector and Z is the solution upon return.  NELT, IA, JA, A and SLAP........800800
C         ISYM are defined as above.  RWORK is a double precision array  SLAP........800900
C         that can be used to pass necessary preconditioning information SLAP........801000
C         and/or workspace to MSOLVE.  IWORK is an integer work array    SLAP........801100
C         for the same purpose as RWORK.                                 SLAP........801200
C NMSL   :INOUT    Integer.                                              SLAP........801300
C         A counter for the number of calls to MSOLVE.                   SLAP........801400
C ITOL   :IN       Integer.                                              SLAP........801500
C         Flag to indicate the type of convergence criterion used.       SLAP........801600
C         ITOL=0  Means the  iteration stops when the test described     SLAP........801700
C                 below on  the  residual RL  is satisfied.  This is     SLAP........801800
C                 the  "Natural Stopping Criteria" for this routine.     SLAP........801900
C                 Other values  of   ITOL  cause  extra,   otherwise     SLAP........802000
C                 unnecessary, computation per iteration and     are     SLAP........802100
C                 therefore much less efficient.                         SLAP........802200
C         ITOL=1  Means   the  iteration stops   when the first test     SLAP........802300
C                 described below on  the residual RL  is satisfied,     SLAP........802400
C                 and there  is either right  or  no preconditioning     SLAP........802500
C                 being used.                                            SLAP........802600
C         ITOL=2  Implies     that   the  user    is   using    left     SLAP........802700
C                 preconditioning, and the second stopping criterion     SLAP........802800
C                 below is used.                                         SLAP........802900
C         ITOL=3  Means the  iteration stops   when  the  third test     SLAP........803000
C                 described below on Minv*Residual is satisfied, and     SLAP........803100
C                 there is either left  or no  preconditioning begin     SLAP........803200
C                 used.                                                  SLAP........803300
C         ITOL=11 is    often  useful  for   checking  and comparing     SLAP........803400
C                 different routines.  For this case, the  user must     SLAP........803500
C                 supply  the  "exact" solution or  a  very accurate     SLAP........803600
C                 approximation (one with  an  error much less  than     SLAP........803700
C                 TOL) through a common block,                           SLAP........803800
C                     COMMON /DSLBLK/ SOLN( )                            SLAP........803900
C                 If ITOL=11, iteration stops when the 2-norm of the     SLAP........804000
C                 difference between the iterative approximation and     SLAP........804100
C                 the user-supplied solution  divided by the  2-norm     SLAP........804200
C                 of the  user-supplied solution  is  less than TOL.     SLAP........804300
C                 Note that this requires  the  user to  set up  the     SLAP........804400
C                 "COMMON     /DSLBLK/ SOLN(LENGTH)"  in the calling     SLAP........804500
C                 routine.  The routine with this declaration should     SLAP........804600
C                 be loaded before the stop test so that the correct     SLAP........804700
C                 length is used by  the loader.  This procedure  is     SLAP........804800
C                 not standard Fortran and may not work correctly on     SLAP........804900
C                 your   system (although  it  has  worked  on every     SLAP........805000
C                 system the authors have tried).  If ITOL is not 11     SLAP........805100
C                 then this common block is indeed standard Fortran.     SLAP........805200
C TOL    :IN       Double Precision.                                     SLAP........805300
C         Convergence criterion, as described above.                     SLAP........805400
C ITMAX  :IN       Integer.                                              SLAP........805500
C         Maximum number of iterations.                                  SLAP........805600
C ITER   :IN       Integer.                                              SLAP........805700
C         The iteration for which to check for convergence.              SLAP........805800
C ERR    :OUT      Double Precision.                                     SLAP........805900
C         Error estimate of error in final approximate solution, as      SLAP........806000
C         defined by ITOL.  Letting norm() denote the Euclidean          SLAP........806100
C         norm, ERR is defined as follows..                              SLAP........806200
C                                                                        SLAP........806300
C         If ITOL=0, then ERR = norm(SB*(B-A*X(L)))/norm(SB*B),          SLAP........806400
C                               for right or no preconditioning, and     SLAP........806500
C                         ERR = norm(SB*(M-inverse)*(B-A*X(L)))/         SLAP........806600
C                                norm(SB*(M-inverse)*B),                 SLAP........806700
C                               for left preconditioning.                SLAP........806800
C         If ITOL=1, then ERR = norm(SB*(B-A*X(L)))/norm(SB*B),          SLAP........806900
C                               since right or no preconditioning        SLAP........807000
C                               being used.                              SLAP........807100
C         If ITOL=2, then ERR = norm(SB*(M-inverse)*(B-A*X(L)))/         SLAP........807200
C                                norm(SB*(M-inverse)*B),                 SLAP........807300
C                               since left preconditioning is being      SLAP........807400
C                               used.                                    SLAP........807500
C         If ITOL=3, then ERR =  Max  |(Minv*(B-A*X(L)))(i)/x(i)|        SLAP........807600
C                               i=1,n                                    SLAP........807700
C         If ITOL=11, then ERR = norm(SB*(X(L)-SOLN))/norm(SB*SOLN).     SLAP........807800
C IUNIT  :IN       Integer.                                              SLAP........807900
C         Unit number on which to write the error at each iteration,     SLAP........808000
C         if this is desired for monitoring convergence.  If unit        SLAP........808100
C         number is 0, no writing will occur.                            SLAP........808200
C R      :INOUT    Double Precision R(N).                                SLAP........808300
C         Work array used in calling routine.  It contains               SLAP........808400
C         information necessary to compute the residual RL = B-A*XL.     SLAP........808500
C Z      :WORK     Double Precision Z(N).                                SLAP........808600
C         Workspace used to hold the pseudo-residual M z = r.            SLAP........808700
C DZ     :WORK     Double Precision DZ(N).                               SLAP........808800
C         Workspace used to hold temporary vector(s).                    SLAP........808900
C RWORK  :WORK     Double Precision RWORK(USER DEFINED).                 SLAP........809000
C         Double Precision array that can be used by MSOLVE.             SLAP........809100
C IWORK  :WORK     Integer IWORK(USER DEFINED).                          SLAP........809200
C         Integer array that can be used by MSOLVE.                      SLAP........809300
C RNRM   :IN       Double Precision.                                     SLAP........809400
C         Norm of the current residual.  Type of norm depends on ITOL.   SLAP........809500
C BNRM   :IN       Double Precision.                                     SLAP........809600
C         Norm of the right hand side.  Type of norm depends on ITOL.    SLAP........809700
C SB     :IN       Double Precision SB(N).                               SLAP........809800
C         Scaling vector for B.                                          SLAP........809900
C SX     :IN       Double Precision SX(N).                               SLAP........810000
C         Scaling vector for X.                                          SLAP........810100
C JSCAL  :IN       Integer.                                              SLAP........810200
C         Flag indicating if scaling arrays SB and SX are being          SLAP........810300
C         used in the calling routine DPIGMR.                            SLAP........810400
C         JSCAL=0 means SB and SX are not used and the                   SLAP........810500
C                 algorithm will perform as if all                       SLAP........810600
C                 SB(i) = 1 and SX(i) = 1.                               SLAP........810700
C         JSCAL=1 means only SX is used, and the algorithm               SLAP........810800
C                 performs as if all SB(i) = 1.                          SLAP........810900
C         JSCAL=2 means only SB is used, and the algorithm               SLAP........811000
C                 performs as if all SX(i) = 1.                          SLAP........811100
C         JSCAL=3 means both SB and SX are used.                         SLAP........811200
C KMP    :IN       Integer                                               SLAP........811300
C         The number of previous vectors the new vector VNEW             SLAP........811400
C         must be made orthogonal to.  (KMP .le. MAXL)                   SLAP........811500
C LGMR   :IN       Integer                                               SLAP........811600
C         The number of GMRES iterations performed on the current call   SLAP........811700
C         to DPIGMR (i.e., # iterations since the last restart) and      SLAP........811800
C         the current order of the upper Hessenberg                      SLAP........811900
C         matrix HES.                                                    SLAP........812000
C MAXL   :IN       Integer                                               SLAP........812100
C         The maximum allowable order of the matrix H.                   SLAP........812200
C MAXLP1 :IN       Integer                                               SLAP........812300
C         MAXPL1 = MAXL + 1, used for dynamic dimensioning of HES.       SLAP........812400
C V      :IN       Double Precision V(N,MAXLP1)                          SLAP........812500
C         The N by (LGMR+1) array containing the LGMR                    SLAP........812600
C         orthogonal vectors V(*,1) to V(*,LGMR).                        SLAP........812700
C Q      :IN       Double Precision Q(2*MAXL)                            SLAP........812800
C         A double precision array of length 2*MAXL containing the       SLAP........812900
C         components of the Givens rotations used in the QR              SLAP........813000
C         decomposition of HES.                                          SLAP........813100
C SNORMW :IN       Double Precision                                      SLAP........813200
C         A scalar containing the scaled norm of VNEW before it          SLAP........813300
C         is renormalized in DPIGMR.                                     SLAP........813400
C PROD   :IN       Double Precision                                      SLAP........813500
C         The product s1*s2*...*sl = the product of the sines of the     SLAP........813600
C         Givens rotations used in the QR factorization of the           SLAP........813700
C         Hessenberg matrix HES.                                         SLAP........813800
C R0NRM  :IN       Double Precision                                      SLAP........813900
C         The scaled norm of initial residual R0.                        SLAP........814000
C HES    :IN       Double Precision HES(MAXLP1,MAXL)                     SLAP........814100
C         The upper triangular factor of the QR decomposition            SLAP........814200
C         of the (LGMR+1) by LGMR upper Hessenberg matrix whose          SLAP........814300
C         entries are the scaled inner-products of A*V(*,I)              SLAP........814400
C         and V(*,K).                                                    SLAP........814500
C JPRE   :IN       Integer                                               SLAP........814600
C         Preconditioner type flag.                                      SLAP........814700
C         (See description of IGWK(4) in DGMRES.)                        SLAP........814800
C                                                                        SLAP........814900
C *Description                                                           SLAP........815000
C       When using the GMRES solver,  the preferred value  for ITOL      SLAP........815100
C       is 0.  This is due to the fact that when ITOL=0 the norm of      SLAP........815200
C       the residual required in the stopping test is  obtained for      SLAP........815300
C       free, since this value is already  calculated  in the GMRES      SLAP........815400
C       algorithm.   The  variable  RNRM contains the   appropriate      SLAP........815500
C       norm, which is equal to norm(SB*(RL - A*XL))  when right or      SLAP........815600
C       no   preconditioning is  being  performed,   and equal   to      SLAP........815700
C       norm(SB*Minv*(RL - A*XL))  when using left preconditioning.      SLAP........815800
C       Here, norm() is the Euclidean norm.  Nonzero values of ITOL      SLAP........815900
C       require  additional work  to  calculate the  actual  scaled      SLAP........816000
C       residual  or its scaled/preconditioned  form,  and/or   the      SLAP........816100
C       approximate solution XL.  Hence, these values of  ITOL will      SLAP........816200
C       not be as efficient as ITOL=0.                                   SLAP........816300
C                                                                        SLAP........816400
C *Cautions:                                                             SLAP........816500
C     This routine will attempt to write to the Fortran logical output   SLAP........816600
C     unit IUNIT, if IUNIT .ne. 0.  Thus, the user must make sure that   SLAP........816700
C     this logical unit is attached to a file or terminal before calling SLAP........816800
C     this routine with a non-zero value for IUNIT.  This routine does   SLAP........816900
C     not check for the validity of a non-zero IUNIT unit number.        SLAP........817000
C                                                                        SLAP........817100
C     This routine does not verify that ITOL has a valid value.          SLAP........817200
C     The calling routine should make such a test before calling         SLAP........817300
C     ISDGMR, as is done in DGMRES.                                      SLAP........817400
C                                                                        SLAP........817500
C***SEE ALSO  DGMRES                                                     SLAP........817600
C***ROUTINES CALLED  D1MACH, DCOPY, DNRM2, DRLCAL, DSCAL, DXLCAL         SLAP........817700
C***COMMON BLOCKS    DSLBLK                                              SLAP........817800
C***REVISION HISTORY  (YYMMDD)                                           SLAP........817900
C   890404  DATE WRITTEN                                                 SLAP........818000
C   890404  Previous REVISION DATE                                       SLAP........818100
C   890915  Made changes requested at July 1989 CML Meeting.  (MKS)      SLAP........818200
C   890922  Numerous changes to prologue to make closer to SLATEC        SLAP........818300
C           standard.  (FNF)                                             SLAP........818400
C   890929  Numerous changes to reduce SP/DP differences.  (FNF)         SLAP........818500
C   910411  Prologue converted to Version 4.0 format.  (BAB)             SLAP........818600
C   910502  Corrected conversion errors, etc.  (FNF)                     SLAP........818700
C   910502  Removed MSOLVE from ROUTINES CALLED list.  (FNF)             SLAP........818800
C   910506  Made subsidiary to DGMRES.  (FNF)                            SLAP........818900
C   920407  COMMON BLOCK renamed DSLBLK.  (WRB)                          SLAP........819000
C   920511  Added complete declaration section.  (WRB)                   SLAP........819100
C   921026  Corrected D to E in output format.  (FNF)                    SLAP........819200
C   921113  Corrected C***CATEGORY line.  (FNF)                          SLAP........819300
C***END PROLOGUE  ISDGMR                                                 SLAP........819400
C     .. Scalar Arguments ..                                             SLAP........819500
      DOUBLE PRECISION BNRM, ERR, PROD, R0NRM, RNRM, SNORMW, TOL         SLAP........819600
      INTEGER ISYM, ITER, ITMAX, ITOL, IUNIT, JPRE, JSCAL, KMP, LGMR,    SLAP........819700
     +        MAXL, MAXLP1, N, NELT, NMSL                                SLAP........819800
C     .. Array Arguments ..                                              SLAP........819900
      DOUBLE PRECISION A(*), B(*), DZ(*), HES(MAXLP1, MAXL), Q(*), R(*), SLAP........820000
     +                 RWORK(*), SB(*), SX(*), V(N,*), X(*), XL(*), Z(*) SLAP........820100
      INTEGER IA(*), IWORK(*), JA(*)                                     SLAP........820200
C     .. Subroutine Arguments ..                                         SLAP........820300
      EXTERNAL MSOLVE                                                    SLAP........820400
C     .. Arrays in Common ..                                             SLAP........820500
      DOUBLE PRECISION SOLN(1)                                           SLAP........820600
C     .. Local Scalars ..                                                SLAP........820700
      DOUBLE PRECISION DXNRM, FUZZ, RAT, RATMAX, SOLNRM, TEM             SLAP........820800
      INTEGER I, IELMAX                                                  SLAP........820900
C     .. External Functions ..                                           SLAP........821000
      DOUBLE PRECISION D1MACH, DNRM2                                     SLAP........821100
      EXTERNAL D1MACH, DNRM2                                             SLAP........821200
C     .. External Subroutines ..                                         SLAP........821300
      EXTERNAL DCOPY, DRLCAL, DSCAL, DXLCAL                              SLAP........821400
C     .. Intrinsic Functions ..                                          SLAP........821500
      INTRINSIC ABS, MAX, SQRT                                           SLAP........821600
C     .. Common blocks ..                                                SLAP........821700
      COMMON /DSLBLK/ SOLN                                               SLAP........821800
C     .. Save statement ..                                               SLAP........821900
      SAVE SOLNRM                                                        SLAP........822000
C***FIRST EXECUTABLE STATEMENT  ISDGMR                                   SLAP........822100
      ISDGMR = 0                                                         SLAP........822200
      IF ( ITOL.EQ.0 ) THEN                                              SLAP........822300
C                                                                        SLAP........822400
C       Use input from DPIGMR to determine if stop conditions are met.   SLAP........822500
C                                                                        SLAP........822600
         ERR = RNRM/BNRM                                                 SLAP........822700
      ENDIF                                                              SLAP........822800
      IF ( (ITOL.GT.0) .AND. (ITOL.LE.3) ) THEN                          SLAP........822900
C                                                                        SLAP........823000
C       Use DRLCAL to calculate the scaled residual vector.              SLAP........823100
C       Store answer in R.                                               SLAP........823200
C                                                                        SLAP........823300
         IF ( LGMR.NE.0 ) CALL DRLCAL(N, KMP, LGMR, MAXL, V, Q, R,       SLAP........823400
     $                                SNORMW, PROD, R0NRM)               SLAP........823500
         IF ( ITOL.LE.2 ) THEN                                           SLAP........823600
C         err = ||Residual||/||RightHandSide||(2-Norms).                 SLAP........823700
            ERR = DNRM2(N, R, 1)/BNRM                                    SLAP........823800
C                                                                        SLAP........823900
C         Unscale R by R0NRM*PROD when KMP < MAXL.                       SLAP........824000
C                                                                        SLAP........824100
            IF ( (KMP.LT.MAXL) .AND. (LGMR.NE.0) ) THEN                  SLAP........824200
               TEM = 1.0D0/(R0NRM*PROD)                                  SLAP........824300
               CALL DSCAL(N, TEM, R, 1)                                  SLAP........824400
            ENDIF                                                        SLAP........824500
         ELSEIF ( ITOL.EQ.3 ) THEN                                       SLAP........824600
C         err = Max |(Minv*Residual)(i)/x(i)|                            SLAP........824700
C         When JPRE .lt. 0, R already contains Minv*Residual.            SLAP........824800
            IF ( JPRE.GT.0 ) THEN                                        SLAP........824900
               CALL MSOLVE(N, R, DZ, NELT, IA, JA, A, ISYM, RWORK,       SLAP........825000
     $              IWORK)                                               SLAP........825100
               NMSL = NMSL + 1                                           SLAP........825200
            ENDIF                                                        SLAP........825300
C                                                                        SLAP........825400
C         Unscale R by R0NRM*PROD when KMP < MAXL.                       SLAP........825500
C                                                                        SLAP........825600
            IF ( (KMP.LT.MAXL) .AND. (LGMR.NE.0) ) THEN                  SLAP........825700
               TEM = 1.0D0/(R0NRM*PROD)                                  SLAP........825800
               CALL DSCAL(N, TEM, R, 1)                                  SLAP........825900
            ENDIF                                                        SLAP........826000
C                                                                        SLAP........826100
            FUZZ = D1MACH(1)                                             SLAP........826200
            IELMAX = 1                                                   SLAP........826300
            RATMAX = ABS(DZ(1))/MAX(ABS(X(1)),FUZZ)                      SLAP........826400
            DO 25 I = 2, N                                               SLAP........826500
               RAT = ABS(DZ(I))/MAX(ABS(X(I)),FUZZ)                      SLAP........826600
               IF( RAT.GT.RATMAX ) THEN                                  SLAP........826700
                  IELMAX = I                                             SLAP........826800
                  RATMAX = RAT                                           SLAP........826900
               ENDIF                                                     SLAP........827000
 25         CONTINUE                                                     SLAP........827100
            ERR = RATMAX                                                 SLAP........827200
            IF( RATMAX.LE.TOL ) ISDGMR = 1                               SLAP........827300
            IF( IUNIT.GT.0 ) WRITE(IUNIT,1020) ITER, IELMAX, RATMAX      SLAP........827400
            RETURN                                                       SLAP........827500
         ENDIF                                                           SLAP........827600
      ENDIF                                                              SLAP........827700
      IF ( ITOL.EQ.11 ) THEN                                             SLAP........827800
C                                                                        SLAP........827900
C       Use DXLCAL to calculate the approximate solution XL.             SLAP........828000
C                                                                        SLAP........828100
         IF ( (LGMR.NE.0) .AND. (ITER.GT.0) ) THEN                       SLAP........828200
            CALL DXLCAL(N, LGMR, X, XL, XL, HES, MAXLP1, Q, V, R0NRM,    SLAP........828300
     $           DZ, SX, JSCAL, JPRE, MSOLVE, NMSL, RWORK, IWORK,        SLAP........828400
     $           NELT, IA, JA, A, ISYM)                                  SLAP........828500
         ELSEIF ( ITER.EQ.0 ) THEN                                       SLAP........828600
C         Copy X to XL to check if initial guess is good enough.         SLAP........828700
            CALL DCOPY(N, X, 1, XL, 1)                                   SLAP........828800
         ELSE                                                            SLAP........828900
C         Return since this is the first call to DPIGMR on a restart.    SLAP........829000
            RETURN                                                       SLAP........829100
         ENDIF                                                           SLAP........829200
C                                                                        SLAP........829300
         IF ((JSCAL .EQ. 0) .OR.(JSCAL .EQ. 2)) THEN                     SLAP........829400
C         err = ||x-TrueSolution||/||TrueSolution||(2-Norms).            SLAP........829500
            IF ( ITER.EQ.0 ) SOLNRM = DNRM2(N, SOLN, 1)                  SLAP........829600
            DO 30 I = 1, N                                               SLAP........829700
               DZ(I) = XL(I) - SOLN(I)                                   SLAP........829800
 30         CONTINUE                                                     SLAP........829900
            ERR = DNRM2(N, DZ, 1)/SOLNRM                                 SLAP........830000
         ELSE                                                            SLAP........830100
            IF (ITER .EQ. 0) THEN                                        SLAP........830200
               SOLNRM = 0                                                SLAP........830300
               DO 40 I = 1,N                                             SLAP........830400
                  SOLNRM = SOLNRM + (SX(I)*SOLN(I))**2                   SLAP........830500
 40            CONTINUE                                                  SLAP........830600
               SOLNRM = SQRT(SOLNRM)                                     SLAP........830700
            ENDIF                                                        SLAP........830800
            DXNRM = 0                                                    SLAP........830900
            DO 50 I = 1,N                                                SLAP........831000
               DXNRM = DXNRM + (SX(I)*(XL(I)-SOLN(I)))**2                SLAP........831100
 50         CONTINUE                                                     SLAP........831200
            DXNRM = SQRT(DXNRM)                                          SLAP........831300
C         err = ||SX*(x-TrueSolution)||/||SX*TrueSolution|| (2-Norms).   SLAP........831400
            ERR = DXNRM/SOLNRM                                           SLAP........831500
         ENDIF                                                           SLAP........831600
      ENDIF                                                              SLAP........831700
C                                                                        SLAP........831800
      IF( IUNIT.NE.0 ) THEN                                              SLAP........831900
         IF( ITER.EQ.0 ) THEN                                            SLAP........832000
C...........THE NEXT LINE OF CODE WAS MODIFIED DURING INTEGRATION        SLAP........832100
C              OF SLAP WITH SUTRA.  IT ORIGINALLY READ:                  SLAP........832200
C              WRITE(IUNIT,1000) N, ITOL, MAXL, KMP                      SLAP........832300
            WRITE(IUNIT,1000)                                            SLAP........832400
         ENDIF                                                           SLAP........832500
C........THE NEXT LINE OF CODE WAS MODIFIED DURING INTEGRATION           SLAP........832600
C           OF SLAP WITH SUTRA.  IT ORIGINALLY READ:                     SLAP........832700
C           WRITE(IUNIT,1010) ITER, RNRM/BNRM, ERR                       SLAP........832800
         WRITE(IUNIT,1010) ITER, ERR                                     SLAP........832900
      ENDIF                                                              SLAP........833000
      IF ( ERR.LE.TOL ) ISDGMR = 1                                       SLAP........833100
C                                                                        SLAP........833200
      RETURN                                                             SLAP........833300
C.....THE NEXT TWO LINES OF CODE REFLECT MODIFICATIONS MADE DURING       SLAP........833400
C        INTEGRATION FO SLAP WITH SUTRA.  THEY ORIGINALLY READ:          SLAP........833500
C        1000 FORMAT(' Generalized Minimum Residual(',I3,I3,') for ',    SLAP........833600
C            $     'N, ITOL = ',I5, I5,                                  SLAP........833700
C            $     /' ITER','   Natural Err Est','   Error Estimate')    SLAP........833800
C        1010 FORMAT(1X,I4,1X,D16.7,1X,D16.7)                            SLAP........833900
1000  FORMAT(1X,6X,'Solver Iteration','   Error Estimate')               SLAP........834000
1010  FORMAT(1X,6X,I16,1X,1PE16.7)                                       SLAP........834100
 1020 FORMAT(1X,' ITER = ',I5, ' IELMAX = ',I5,                          SLAP........834200
     $     ' |R(IELMAX)/X(IELMAX)| = ',D12.5)                            SLAP........834300
C------------- LAST LINE OF ISDGMR FOLLOWS ----------------------------  SLAP........834400
      END                                                                SLAP........834500
*DECK ISDOMN                                                             SLAP........834600
      INTEGER FUNCTION ISDOMN (N, B, X, NELT, IA, JA, A, ISYM, MSOLVE,   SLAP........834700
     +   NSAVE, ITOL, TOL, ITMAX, ITER, ERR, IERR, IUNIT, R, Z, P, AP,   SLAP........834800
     +   EMAP, DZ, CSAV, RWORK, IWORK, AK, BNRM, SOLNRM)                 SLAP........834900
C***BEGIN PROLOGUE  ISDOMN                                               SLAP........835000
C***SUBSIDIARY                                                           SLAP........835100
C***PURPOSE  Preconditioned Orthomin Stop Test.                          SLAP........835200
C            This routine calculates the stop test for the Orthomin      SLAP........835300
C            iteration scheme.  It returns a non-zero if the error       SLAP........835400
C            estimate (the type of which is determined by ITOL) is       SLAP........835500
C            less than the user specified tolerance TOL.                 SLAP........835600
C***LIBRARY   SLATEC (SLAP)                                              SLAP........835700
C***CATEGORY  D2A4, D2B4                                                 SLAP........835800
C***TYPE      DOUBLE PRECISION (ISSOMN-S, ISDOMN-D)                      SLAP........835900
C***KEYWORDS  ITERATIVE PRECONDITION, NON-SYMMETRIC LINEAR SYSTEM,       SLAP........836000
C             ORTHOMIN, SLAP, SPARSE, STOP TEST                          SLAP........836100
C***AUTHOR  Greenbaum, Anne, (Courant Institute)                         SLAP........836200
C           Seager, Mark K., (LLNL)                                      SLAP........836300
C             Lawrence Livermore National Laboratory                     SLAP........836400
C             PO BOX 808, L-60                                           SLAP........836500
C             Livermore, CA 94550 (510) 423-3141                         SLAP........836600
C             seager@llnl.gov                                            SLAP........836700
C***DESCRIPTION                                                          SLAP........836800
C                                                                        SLAP........836900
C *Usage:                                                                SLAP........837000
C     INTEGER  N, NELT, IA(NELT), JA(NELT), ISYM, NSAVE, ITOL, ITMAX     SLAP........837100
C     INTEGER  ITER, IERR, IUNIT, IWORK(USER DEFINED)                    SLAP........837200
C     DOUBLE PRECISION B(N), X(N), A(NELT), TOL, ERR, R(N), Z(N)         SLAP........837300
C     DOUBLE PRECISION P(N,0:NSAVE), AP(N,0:NSAVE), EMAP(N,0:NSAVE)      SLAP........837400
C     DOUBLE PRECISION DZ(N), CSAV(NSAVE), RWORK(USER DEFINED), AK       SLAP........837500
C     DOUBLE PRECISION BNRM, SOLNRM                                      SLAP........837600
C     EXTERNAL MSOLVE                                                    SLAP........837700
C                                                                        SLAP........837800
C     IF( ISDOMN(N, B, X, NELT, IA, JA, A, ISYM, MSOLVE, NSAVE,          SLAP........837900
C    $     ITOL, TOL, ITMAX, ITER, ERR, IERR, IUNIT, R, Z, P, AP,        SLAP........838000
C    $     EMAP, DZ, CSAV, RWORK, IWORK, AK, BNRM, SOLNRM)               SLAP........838100
C    $     .NE.0 ) THEN ITERATION CONVERGED                              SLAP........838200
C                                                                        SLAP........838300
C *Arguments:                                                            SLAP........838400
C N      :IN       Integer.                                              SLAP........838500
C         Order of the matrix.                                           SLAP........838600
C B      :IN       Double Precision B(N).                                SLAP........838700
C         Right-hand side vector.                                        SLAP........838800
C X      :IN       Double Precision X(N).                                SLAP........838900
C         On input X is your initial guess for solution vector.          SLAP........839000
C         On output X is the final approximate solution.                 SLAP........839100
C NELT   :IN       Integer.                                              SLAP........839200
C         Number of Non-Zeros stored in A.                               SLAP........839300
C IA     :IN       Integer IA(NELT).                                     SLAP........839400
C JA     :IN       Integer JA(NELT).                                     SLAP........839500
C A      :IN       Double Precision A(NELT).                             SLAP........839600
C         These arrays should hold the matrix A in either the SLAP       SLAP........839700
C         Triad format or the SLAP Column format.  See "Description"     SLAP........839800
C         in the DSDOMN or DSLUOM prologue.                              SLAP........839900
C ISYM   :IN       Integer.                                              SLAP........840000
C         Flag to indicate symmetric storage format.                     SLAP........840100
C         If ISYM=0, all non-zero entries of the matrix are stored.      SLAP........840200
C         If ISYM=1, the matrix is symmetric, and only the upper         SLAP........840300
C         or lower triangle of the matrix is stored.                     SLAP........840400
C MSOLVE :EXT      External.                                             SLAP........840500
C         Name of a routine which solves a linear system MZ = R for      SLAP........840600
C         Z given R with the preconditioning matrix M (M is supplied via SLAP........840700
C         RWORK and IWORK arrays).  The name of the MSOLVE routine must  SLAP........840800
C         be declared external in the calling program.  The calling      SLAP........840900
C         sequence to MSOLVE is:                                         SLAP........841000
C             CALL MSOLVE(N, R, Z, NELT, IA, JA, A, ISYM, RWORK, IWORK)  SLAP........841100
C         Where N is the number of unknowns, R is the right-hand side    SLAP........841200
C         vector and Z is the solution upon return.  NELT, IA, JA, A and SLAP........841300
C         ISYM are defined as above.  RWORK is a double precision array  SLAP........841400
C         that can be used to pass necessary preconditioning information SLAP........841500
C         and/or workspace to MSOLVE.  IWORK is an integer work array    SLAP........841600
C         for the same purpose as RWORK.                                 SLAP........841700
C NSAVE  :IN       Integer.                                              SLAP........841800
C         Number of direction vectors to save and orthogonalize against. SLAP........841900
C ITOL   :IN       Integer.                                              SLAP........842000
C         Flag to indicate type of convergence criterion.                SLAP........842100
C         If ITOL=1, iteration stops when the 2-norm of the residual     SLAP........842200
C         divided by the 2-norm of the right-hand side is less than TOL. SLAP........842300
C         If ITOL=2, iteration stops when the 2-norm of M-inv times the  SLAP........842400
C         residual divided by the 2-norm of M-inv times the right hand   SLAP........842500
C         side is less than TOL, where M-inv is the inverse of the       SLAP........842600
C         diagonal of A.                                                 SLAP........842700
C         ITOL=11 is often useful for checking and comparing different   SLAP........842800
C         routines.  For this case, the user must supply the "exact"     SLAP........842900
C         solution or a very accurate approximation (one with an error   SLAP........843000
C         much less than TOL) through a common block,                    SLAP........843100
C             COMMON /DSLBLK/ SOLN( )                                    SLAP........843200
C         If ITOL=11, iteration stops when the 2-norm of the difference  SLAP........843300
C         between the iterative approximation and the user-supplied      SLAP........843400
C         solution divided by the 2-norm of the user-supplied solution   SLAP........843500
C         is less than TOL.  Note that this requires the user to set up  SLAP........843600
C         the "COMMON /DSLBLK/ SOLN(LENGTH)" in the calling routine.     SLAP........843700
C         The routine with this declaration should be loaded before the  SLAP........843800
C         stop test so that the correct length is used by the loader.    SLAP........843900
C         This procedure is not standard Fortran and may not work        SLAP........844000
C         correctly on your system (although it has worked on every      SLAP........844100
C         system the authors have tried).  If ITOL is not 11 then this   SLAP........844200
C         common block is indeed standard Fortran.                       SLAP........844300
C TOL    :IN       Double Precision.                                     SLAP........844400
C         Convergence criterion, as described above.                     SLAP........844500
C ITMAX  :IN       Integer.                                              SLAP........844600
C         Maximum number of iterations.                                  SLAP........844700
C ITER   :IN       Integer.                                              SLAP........844800
C         Current iteration count.  (Must be zero on first call.)        SLAP........844900
C ERR    :OUT      Double Precision.                                     SLAP........845000
C         Error estimate of error in final approximate solution, as      SLAP........845100
C         defined by ITOL.                                               SLAP........845200
C IERR   :OUT      Integer.                                              SLAP........845300
C         Error flag.  IERR is set to 3 if ITOL is not one of the        SLAP........845400
C         acceptable values, see above.                                  SLAP........845500
C IUNIT  :IN       Integer.                                              SLAP........845600
C         Unit number on which to write the error at each iteration,     SLAP........845700
C         if this is desired for monitoring convergence.  If unit        SLAP........845800
C         number is 0, no writing will occur.                            SLAP........845900
C R      :IN       Double Precision R(N).                                SLAP........846000
C         The residual R = B-AX.                                         SLAP........846100
C Z      :WORK     Double Precision Z(N).                                SLAP........846200
C P      :IN       Double Precision P(N,0:NSAVE).                        SLAP........846300
C         Workspace used to hold the conjugate direction vector(s).      SLAP........846400
C AP     :IN       Double Precision AP(N,0:NSAVE).                       SLAP........846500
C         Workspace used to hold the matrix A times the P vector(s).     SLAP........846600
C EMAP   :IN       Double Precision EMAP(N,0:NSAVE).                     SLAP........846700
C         Workspace used to hold M-inv times the AP vector(s).           SLAP........846800
C DZ     :WORK     Double Precision DZ(N).                               SLAP........846900
C         Workspace.                                                     SLAP........847000
C CSAV   :DUMMY    Double Precision CSAV(NSAVE)                          SLAP........847100
C         Reserved for future use.                                       SLAP........847200
C RWORK  :WORK     Double Precision RWORK(USER DEFINED).                 SLAP........847300
C         Double Precision array that can be used for workspace in       SLAP........847400
C         MSOLVE.                                                        SLAP........847500
C IWORK  :WORK     Integer IWORK(USER DEFINED).                          SLAP........847600
C         Integer array that can be used for workspace in MSOLVE.        SLAP........847700
C AK     :IN       Double Precision.                                     SLAP........847800
C         Current iterate Orthomin iteration parameter.                  SLAP........847900
C BNRM   :OUT      Double Precision.                                     SLAP........848000
C         Current solution B-norm, if ITOL = 1 or 2.                     SLAP........848100
C SOLNRM :OUT      Double Precision.                                     SLAP........848200
C         True solution norm, if ITOL = 11.                              SLAP........848300
C                                                                        SLAP........848400
C *Function Return Values:                                               SLAP........848500
C       0 : Error estimate (determined by ITOL) is *NOT* less than the   SLAP........848600
C           specified tolerance, TOL.  The iteration must continue.      SLAP........848700
C       1 : Error estimate (determined by ITOL) is less than the         SLAP........848800
C           specified tolerance, TOL.  The iteration can be considered   SLAP........848900
C           complete.                                                    SLAP........849000
C                                                                        SLAP........849100
C *Cautions:                                                             SLAP........849200
C     This routine will attempt to write to the Fortran logical output   SLAP........849300
C     unit IUNIT, if IUNIT .ne. 0.  Thus, the user must make sure that   SLAP........849400
C     this logical unit is attached to a file or terminal before calling SLAP........849500
C     this routine with a non-zero value for IUNIT.  This routine does   SLAP........849600
C     not check for the validity of a non-zero IUNIT unit number.        SLAP........849700
C                                                                        SLAP........849800
C***SEE ALSO  DOMN, DSDOMN, DSLUOM                                       SLAP........849900
C***ROUTINES CALLED  D1MACH, DNRM2                                       SLAP........850000
C***COMMON BLOCKS    DSLBLK                                              SLAP........850100
C***REVISION HISTORY  (YYMMDD)                                           SLAP........850200
C   890404  DATE WRITTEN                                                 SLAP........850300
C   890404  Previous REVISION DATE                                       SLAP........850400
C   890915  Made changes requested at July 1989 CML Meeting.  (MKS)      SLAP........850500
C   890922  Numerous changes to prologue to make closer to SLATEC        SLAP........850600
C           standard.  (FNF)                                             SLAP........850700
C   890929  Numerous changes to reduce SP/DP differences.  (FNF)         SLAP........850800
C   891003  Removed C***REFER TO line, per MKS.                          SLAP........850900
C   910411  Prologue converted to Version 4.0 format.  (BAB)             SLAP........851000
C   910502  Removed MSOLVE from ROUTINES CALLED list.  (FNF)             SLAP........851100
C   910506  Made subsidiary to DOMN.  (FNF)                              SLAP........851200
C   920407  COMMON BLOCK renamed DSLBLK.  (WRB)                          SLAP........851300
C   920511  Added complete declaration section.  (WRB)                   SLAP........851400
C   920930  Corrected to not print AK when ITER=0.  (FNF)                SLAP........851500
C   921026  Changed 1.0E10 to D1MACH(2) and corrected D to E in          SLAP........851600
C           output format.  (FNF)                                        SLAP........851700
C   921113  Corrected C***CATEGORY line.  (FNF)                          SLAP........851800
C***END PROLOGUE  ISDOMN                                                 SLAP........851900
C     .. Scalar Arguments ..                                             SLAP........852000
      DOUBLE PRECISION AK, BNRM, ERR, SOLNRM, TOL                        SLAP........852100
      INTEGER IERR, ISYM, ITER, ITMAX, ITOL, IUNIT, N, NELT, NSAVE       SLAP........852200
C     .. Array Arguments ..                                              SLAP........852300
      DOUBLE PRECISION A(NELT), AP(N,0:NSAVE), B(N), CSAV(NSAVE),        SLAP........852400
     +                 DZ(N), EMAP(N,0:NSAVE), P(N,0:NSAVE), R(N),       SLAP........852500
     +                 RWORK(*), X(N), Z(N)                              SLAP........852600
      INTEGER IA(NELT), IWORK(*), JA(NELT)                               SLAP........852700
C     .. Subroutine Arguments ..                                         SLAP........852800
      EXTERNAL MSOLVE                                                    SLAP........852900
C     .. Arrays in Common ..                                             SLAP........853000
      DOUBLE PRECISION SOLN(1)                                           SLAP........853100
C     .. Local Scalars ..                                                SLAP........853200
      INTEGER I                                                          SLAP........853300
C     .. External Functions ..                                           SLAP........853400
      DOUBLE PRECISION D1MACH, DNRM2                                     SLAP........853500
      EXTERNAL D1MACH, DNRM2                                             SLAP........853600
C     .. Common blocks ..                                                SLAP........853700
      COMMON /DSLBLK/ SOLN                                               SLAP........853800
C***FIRST EXECUTABLE STATEMENT  ISDOMN                                   SLAP........853900
      ISDOMN = 0                                                         SLAP........854000
C                                                                        SLAP........854100
      IF( ITOL.EQ.1 ) THEN                                               SLAP........854200
C         err = ||Residual||/||RightHandSide|| (2-Norms).                SLAP........854300
         IF(ITER .EQ. 0) BNRM = DNRM2(N, B, 1)                           SLAP........854400
         ERR = DNRM2(N, R, 1)/BNRM                                       SLAP........854500
      ELSE IF( ITOL.EQ.2 ) THEN                                          SLAP........854600
C                  -1              -1                                    SLAP........854700
C         err = ||M  Residual||/||M  RightHandSide|| (2-Norms).          SLAP........854800
         IF(ITER .EQ. 0) THEN                                            SLAP........854900
            CALL MSOLVE(N, B, DZ, NELT, IA, JA, A, ISYM, RWORK, IWORK)   SLAP........855000
            BNRM = DNRM2(N, DZ, 1)                                       SLAP........855100
         ENDIF                                                           SLAP........855200
         ERR = DNRM2(N, Z, 1)/BNRM                                       SLAP........855300
      ELSE IF( ITOL.EQ.11 ) THEN                                         SLAP........855400
C         err = ||x-TrueSolution||/||TrueSolution|| (2-Norms).           SLAP........855500
         IF(ITER .EQ. 0) SOLNRM = DNRM2(N, SOLN, 1)                      SLAP........855600
         DO 10 I = 1, N                                                  SLAP........855700
            DZ(I) = X(I) - SOLN(I)                                       SLAP........855800
 10      CONTINUE                                                        SLAP........855900
         ERR = DNRM2(N, DZ, 1)/SOLNRM                                    SLAP........856000
      ELSE                                                               SLAP........856100
C                                                                        SLAP........856200
C         If we get here ITOL is not one of the acceptable values.       SLAP........856300
         ERR = D1MACH(2)                                                 SLAP........856400
         IERR = 3                                                        SLAP........856500
      ENDIF                                                              SLAP........856600
C                                                                        SLAP........856700
C.....THE BLOCK IF STATEMENT THAT IMMEDIATELY FOLLOWS THIS COMMMENT      SLAP........856800
C        WAS MODIFIED DURING INTEGRATION OF SLAP WITH SUTRA.  IT         SLAP........856900
C        ORIGINALLY READ:                                                SLAP........857000
C        IF(IUNIT .NE. 0) THEN                                           SLAP........857100
C           IF( ITER.EQ.0 ) THEN                                         SLAP........857200
C              WRITE(IUNIT,1000) NSAVE, N, ITOL                          SLAP........857300
C              WRITE(IUNIT,1010) ITER, ERR                               SLAP........857400
C           ELSE                                                         SLAP........857500
C              WRITE(IUNIT,1010) ITER, ERR, AK                           SLAP........857600
C           ENDIF                                                        SLAP........857700
C        ENDIF                                                           SLAP........857800
      IF(IUNIT .NE. 0) THEN                                              SLAP........857900
         IF( ITER.EQ.0 ) WRITE(IUNIT,1000)                               SLAP........858000
         WRITE(IUNIT,1010) ITER, ERR                                     SLAP........858100
      ENDIF                                                              SLAP........858200
      IF(ERR .LE. TOL) ISDOMN = 1                                        SLAP........858300
C                                                                        SLAP........858400
      RETURN                                                             SLAP........858500
C.....THE NEXT TWO LINES OF CODE REFLECT MODIFICATIONS MADE DURING       SLAP........858600
C        INTEGRATION OF SLAP WITH SUTRA.  THEY ORIGINALLY READ:          SLAP........858700
C        1000 FORMAT(' Preconditioned Orthomin(',I3,') for ',            SLAP........858800
C            $     'N, ITOL = ',I5, I5,                                  SLAP........858900
C            $     /' ITER','   Error Estimate','            Alpha')     SLAP........859000
C        1010 FORMAT(1X,I4,1X,D16.7,1X,D16.7)                            SLAP........859100
1000  FORMAT(1X,6X,'Solver Iteration','   Error Estimate')               SLAP........859200
1010  FORMAT(1X,6X,I16,1X,1PE16.7)                                       SLAP........859300
C------------- LAST LINE OF ISDOMN FOLLOWS ----------------------------  SLAP........859400
      END                                                                SLAP........859500
*DECK J4SAVE                                                             SLAP........859600
      FUNCTION J4SAVE (IWHICH, IVALUE, ISET)                             SLAP........859700
C***BEGIN PROLOGUE  J4SAVE                                               SLAP........859800
C***SUBSIDIARY                                                           SLAP........859900
C***PURPOSE  Save or recall global variables needed by error             SLAP........860000
C            handling routines.                                          SLAP........860100
C***LIBRARY   SLATEC (XERROR)                                            SLAP........860200
C***TYPE      INTEGER (J4SAVE-I)                                         SLAP........860300
C***KEYWORDS  ERROR MESSAGES, ERROR NUMBER, RECALL, SAVE, XERROR         SLAP........860400
C***AUTHOR  Jones, R. E., (SNLA)                                         SLAP........860500
C***DESCRIPTION                                                          SLAP........860600
C                                                                        SLAP........860700
C     Abstract                                                           SLAP........860800
C        J4SAVE saves and recalls several global variables needed        SLAP........860900
C        by the library error handling routines.                         SLAP........861000
C                                                                        SLAP........861100
C     Description of Parameters                                          SLAP........861200
C      --Input--                                                         SLAP........861300
C        IWHICH - Index of item desired.                                 SLAP........861400
C                = 1 Refers to current error number.                     SLAP........861500
C                = 2 Refers to current error control flag.               SLAP........861600
C                = 3 Refers to current unit number to which error        SLAP........861700
C                    messages are to be sent.  (0 means use standard.)   SLAP........861800
C                = 4 Refers to the maximum number of times any           SLAP........861900
C                     message is to be printed (as set by XERMAX).       SLAP........862000
C                = 5 Refers to the total number of units to which        SLAP........862100
C                     each error message is to be written.               SLAP........862200
C                = 6 Refers to the 2nd unit for error messages           SLAP........862300
C                = 7 Refers to the 3rd unit for error messages           SLAP........862400
C                = 8 Refers to the 4th unit for error messages           SLAP........862500
C                = 9 Refers to the 5th unit for error messages           SLAP........862600
C        IVALUE - The value to be set for the IWHICH-th parameter,       SLAP........862700
C                 if ISET is .TRUE. .                                    SLAP........862800
C        ISET   - If ISET=.TRUE., the IWHICH-th parameter will BE        SLAP........862900
C                 given the value, IVALUE.  If ISET=.FALSE., the         SLAP........863000
C                 IWHICH-th parameter will be unchanged, and IVALUE      SLAP........863100
C                 is a dummy parameter.                                  SLAP........863200
C      --Output--                                                        SLAP........863300
C        The (old) value of the IWHICH-th parameter will be returned     SLAP........863400
C        in the function value, J4SAVE.                                  SLAP........863500
C                                                                        SLAP........863600
C***SEE ALSO  XERMSG                                                     SLAP........863700
C***REFERENCES  R. E. Jones and D. K. Kahaner, XERROR, the SLATEC        SLAP........863800
C                 Error-handling Package, SAND82-0800, Sandia            SLAP........863900
C                 Laboratories, 1982.                                    SLAP........864000
C***ROUTINES CALLED  (NONE)                                              SLAP........864100
C***REVISION HISTORY  (YYMMDD)                                           SLAP........864200
C   790801  DATE WRITTEN                                                 SLAP........864300
C   891214  Prologue converted to Version 4.0 format.  (BAB)             SLAP........864400
C   900205  Minor modifications to prologue.  (WRB)                      SLAP........864500
C   900402  Added TYPE section.  (WRB)                                   SLAP........864600
C   910411  Added KEYWORDS section.  (WRB)                               SLAP........864700
C   920501  Reformatted the REFERENCES section.  (WRB)                   SLAP........864800
C***END PROLOGUE  J4SAVE                                                 SLAP........864900
      LOGICAL ISET                                                       SLAP........865000
      INTEGER IPARAM(9)                                                  SLAP........865100
      SAVE IPARAM                                                        SLAP........865200
      DATA IPARAM(1),IPARAM(2),IPARAM(3),IPARAM(4)/0,2,0,10/             SLAP........865300
      DATA IPARAM(5)/1/                                                  SLAP........865400
      DATA IPARAM(6),IPARAM(7),IPARAM(8),IPARAM(9)/0,0,0,0/              SLAP........865500
C***FIRST EXECUTABLE STATEMENT  J4SAVE                                   SLAP........865600
      J4SAVE = IPARAM(IWHICH)                                            SLAP........865700
      IF (ISET) IPARAM(IWHICH) = IVALUE                                  SLAP........865800
      RETURN                                                             SLAP........865900
      END                                                                SLAP........866000
*DECK QS2I1D                                                             SLAP........866100
      SUBROUTINE QS2I1D (IA, JA, A, N, KFLAG)                            SLAP........866200
C***BEGIN PROLOGUE  QS2I1D                                               SLAP........866300
C***SUBSIDIARY                                                           SLAP........866400
C***PURPOSE  Sort an integer array, moving an integer and DP array.      SLAP........866500
C            This routine sorts the integer array IA and makes the same  SLAP........866600
C            interchanges in the integer array JA and the double pre-    SLAP........866700
C            cision array A.  The array IA may be sorted in increasing   SLAP........866800
C            order or decreasing order.  A slightly modified QUICKSORT   SLAP........866900
C            algorithm is used.                                          SLAP........867000
C***LIBRARY   SLATEC (SLAP)                                              SLAP........867100
C***CATEGORY  N6A2A                                                      SLAP........867200
C***TYPE      DOUBLE PRECISION (QS2I1R-S, QS2I1D-D)                      SLAP........867300
C***KEYWORDS  SINGLETON QUICKSORT, SLAP, SORT, SORTING                   SLAP........867400
C***AUTHOR  Jones, R. E., (SNLA)                                         SLAP........867500
C           Kahaner, D. K., (NBS)                                        SLAP........867600
C           Seager, M. K., (LLNL) seager@llnl.gov                        SLAP........867700
C           Wisniewski, J. A., (SNLA)                                    SLAP........867800
C***DESCRIPTION                                                          SLAP........867900
C     Written by Rondall E Jones                                         SLAP........868000
C     Modified by John A. Wisniewski to use the Singleton QUICKSORT      SLAP........868100
C     algorithm. date 18 November 1976.                                  SLAP........868200
C                                                                        SLAP........868300
C     Further modified by David K. Kahaner                               SLAP........868400
C     National Bureau of Standards                                       SLAP........868500
C     August, 1981                                                       SLAP........868600
C                                                                        SLAP........868700
C     Even further modification made to bring the code up to the         SLAP........868800
C     Fortran 77 level and make it more readable and to carry            SLAP........868900
C     along one integer array and one double precision array during      SLAP........869000
C     the sort by                                                        SLAP........869100
C     Mark K. Seager                                                     SLAP........869200
C     Lawrence Livermore National Laboratory                             SLAP........869300
C     November, 1987                                                     SLAP........869400
C     This routine was adapted from the ISORT routine.                   SLAP........869500
C                                                                        SLAP........869600
C     ABSTRACT                                                           SLAP........869700
C         This routine sorts an integer array IA and makes the same      SLAP........869800
C         interchanges in the integer array JA and the double precision  SLAP........869900
C         array A.                                                       SLAP........870000
C         The array IA may be sorted in increasing order or decreasing   SLAP........870100
C         order.  A slightly modified quicksort algorithm is used.       SLAP........870200
C                                                                        SLAP........870300
C     DESCRIPTION OF PARAMETERS                                          SLAP........870400
C        IA - Integer array of values to be sorted.                      SLAP........870500
C        JA - Integer array to be carried along.                         SLAP........870600
C         A - Double Precision array to be carried along.                SLAP........870700
C         N - Number of values in integer array IA to be sorted.         SLAP........870800
C     KFLAG - Control parameter                                          SLAP........870900
C           = 1 means sort IA in INCREASING order.                       SLAP........871000
C           =-1 means sort IA in DECREASING order.                       SLAP........871100
C                                                                        SLAP........871200
C***SEE ALSO  DS2Y                                                       SLAP........871300
C***REFERENCES  R. C. Singleton, Algorithm 347, An Efficient Algorithm   SLAP........871400
C                 for Sorting With Minimal Storage, Communications ACM   SLAP........871500
C                 12:3 (1969), pp.185-7.                                 SLAP........871600
C***ROUTINES CALLED  XERMSG                                              SLAP........871700
C***REVISION HISTORY  (YYMMDD)                                           SLAP........871800
C   761118  DATE WRITTEN                                                 SLAP........871900
C   890125  Previous REVISION DATE                                       SLAP........872000
C   890915  Made changes requested at July 1989 CML Meeting.  (MKS)      SLAP........872100
C   890922  Numerous changes to prologue to make closer to SLATEC        SLAP........872200
C           standard.  (FNF)                                             SLAP........872300
C   890929  Numerous changes to reduce SP/DP differences.  (FNF)         SLAP........872400
C   900805  Changed XERROR calls to calls to XERMSG.  (RWC)              SLAP........872500
C   910411  Prologue converted to Version 4.0 format.  (BAB)             SLAP........872600
C   910506  Made subsidiary to DS2Y and corrected reference.  (FNF)      SLAP........872700
C   920511  Added complete declaration section.  (WRB)                   SLAP........872800
C   920929  Corrected format of reference.  (FNF)                        SLAP........872900
C   921012  Corrected all f.p. constants to double precision.  (FNF)     SLAP........873000
C***END PROLOGUE  QS2I1D                                                 SLAP........873100
CVD$R NOVECTOR                                                           SLAP........873200
CVD$R NOCONCUR                                                           SLAP........873300
C     .. Scalar Arguments ..                                             SLAP........873400
      INTEGER KFLAG, N                                                   SLAP........873500
C     .. Array Arguments ..                                              SLAP........873600
      DOUBLE PRECISION A(N)                                              SLAP........873700
      INTEGER IA(N), JA(N)                                               SLAP........873800
C     .. Local Scalars ..                                                SLAP........873900
      DOUBLE PRECISION R, TA, TTA                                        SLAP........874000
      INTEGER I, IIT, IJ, IT, J, JJT, JT, K, KK, L, M, NN                SLAP........874100
C     .. Local Arrays ..                                                 SLAP........874200
      INTEGER IL(21), IU(21)                                             SLAP........874300
C     .. External Subroutines ..                                         SLAP........874400
      EXTERNAL XERMSG                                                    SLAP........874500
C     .. Intrinsic Functions ..                                          SLAP........874600
      INTRINSIC ABS, INT                                                 SLAP........874700
C***FIRST EXECUTABLE STATEMENT  QS2I1D                                   SLAP........874800
      NN = N                                                             SLAP........874900
      IF (NN.LT.1) THEN                                                  SLAP........875000
         CALL XERMSG ('SLATEC', 'QS2I1D',                                SLAP........875100
     $      'The number of values to be sorted was not positive.', 1, 1) SLAP........875200
         RETURN                                                          SLAP........875300
      ENDIF                                                              SLAP........875400
      IF( N.EQ.1 ) RETURN                                                SLAP........875500
      KK = ABS(KFLAG)                                                    SLAP........875600
      IF ( KK.NE.1 ) THEN                                                SLAP........875700
         CALL XERMSG ('SLATEC', 'QS2I1D',                                SLAP........875800
     $      'The sort control parameter, K, was not 1 or -1.', 2, 1)     SLAP........875900
         RETURN                                                          SLAP........876000
      ENDIF                                                              SLAP........876100
C                                                                        SLAP........876200
C     Alter array IA to get decreasing order if needed.                  SLAP........876300
C                                                                        SLAP........876400
      IF( KFLAG.LT.1 ) THEN                                              SLAP........876500
         DO 20 I=1,NN                                                    SLAP........876600
            IA(I) = -IA(I)                                               SLAP........876700
 20      CONTINUE                                                        SLAP........876800
      ENDIF                                                              SLAP........876900
C                                                                        SLAP........877000
C     Sort IA and carry JA and A along.                                  SLAP........877100
C     And now...Just a little black magic...                             SLAP........877200
      M = 1                                                              SLAP........877300
      I = 1                                                              SLAP........877400
      J = NN                                                             SLAP........877500
      R = .375D0                                                         SLAP........877600
 210  IF( R.LE.0.5898437D0 ) THEN                                        SLAP........877700
         R = R + 3.90625D-2                                              SLAP........877800
      ELSE                                                               SLAP........877900
         R = R-.21875D0                                                  SLAP........878000
      ENDIF                                                              SLAP........878100
 225  K = I                                                              SLAP........878200
C                                                                        SLAP........878300
C     Select a central element of the array and save it in location      SLAP........878400
C     it, jt, at.                                                        SLAP........878500
C                                                                        SLAP........878600
      IJ = I + INT ((J-I)*R)                                             SLAP........878700
      IT = IA(IJ)                                                        SLAP........878800
      JT = JA(IJ)                                                        SLAP........878900
      TA = A(IJ)                                                         SLAP........879000
C                                                                        SLAP........879100
C     If first element of array is greater than it, interchange with it. SLAP........879200
C                                                                        SLAP........879300
      IF( IA(I).GT.IT ) THEN                                             SLAP........879400
         IA(IJ) = IA(I)                                                  SLAP........879500
         IA(I)  = IT                                                     SLAP........879600
         IT     = IA(IJ)                                                 SLAP........879700
         JA(IJ) = JA(I)                                                  SLAP........879800
         JA(I)  = JT                                                     SLAP........879900
         JT     = JA(IJ)                                                 SLAP........880000
         A(IJ)  = A(I)                                                   SLAP........880100
         A(I)   = TA                                                     SLAP........880200
         TA     = A(IJ)                                                  SLAP........880300
      ENDIF                                                              SLAP........880400
      L=J                                                                SLAP........880500
C                                                                        SLAP........880600
C     If last element of array is less than it, swap with it.            SLAP........880700
C                                                                        SLAP........880800
      IF( IA(J).LT.IT ) THEN                                             SLAP........880900
         IA(IJ) = IA(J)                                                  SLAP........881000
         IA(J)  = IT                                                     SLAP........881100
         IT     = IA(IJ)                                                 SLAP........881200
         JA(IJ) = JA(J)                                                  SLAP........881300
         JA(J)  = JT                                                     SLAP........881400
         JT     = JA(IJ)                                                 SLAP........881500
         A(IJ)  = A(J)                                                   SLAP........881600
         A(J)   = TA                                                     SLAP........881700
         TA     = A(IJ)                                                  SLAP........881800
C                                                                        SLAP........881900
C     If first element of array is greater than it, swap with it.        SLAP........882000
C                                                                        SLAP........882100
         IF ( IA(I).GT.IT ) THEN                                         SLAP........882200
            IA(IJ) = IA(I)                                               SLAP........882300
            IA(I)  = IT                                                  SLAP........882400
            IT     = IA(IJ)                                              SLAP........882500
            JA(IJ) = JA(I)                                               SLAP........882600
            JA(I)  = JT                                                  SLAP........882700
            JT     = JA(IJ)                                              SLAP........882800
            A(IJ)  = A(I)                                                SLAP........882900
            A(I)   = TA                                                  SLAP........883000
            TA     = A(IJ)                                               SLAP........883100
         ENDIF                                                           SLAP........883200
      ENDIF                                                              SLAP........883300
C                                                                        SLAP........883400
C     Find an element in the second half of the array which is           SLAP........883500
C     smaller than it.                                                   SLAP........883600
C                                                                        SLAP........883700
  240 L=L-1                                                              SLAP........883800
      IF( IA(L).GT.IT ) GO TO 240                                        SLAP........883900
C                                                                        SLAP........884000
C     Find an element in the first half of the array which is            SLAP........884100
C     greater than it.                                                   SLAP........884200
C                                                                        SLAP........884300
  245 K=K+1                                                              SLAP........884400
      IF( IA(K).LT.IT ) GO TO 245                                        SLAP........884500
C                                                                        SLAP........884600
C     Interchange these elements.                                        SLAP........884700
C                                                                        SLAP........884800
      IF( K.LE.L ) THEN                                                  SLAP........884900
         IIT   = IA(L)                                                   SLAP........885000
         IA(L) = IA(K)                                                   SLAP........885100
         IA(K) = IIT                                                     SLAP........885200
         JJT   = JA(L)                                                   SLAP........885300
         JA(L) = JA(K)                                                   SLAP........885400
         JA(K) = JJT                                                     SLAP........885500
         TTA   = A(L)                                                    SLAP........885600
         A(L)  = A(K)                                                    SLAP........885700
         A(K)  = TTA                                                     SLAP........885800
         GOTO 240                                                        SLAP........885900
      ENDIF                                                              SLAP........886000
C                                                                        SLAP........886100
C     Save upper and lower subscripts of the array yet to be sorted.     SLAP........886200
C                                                                        SLAP........886300
      IF( L-I.GT.J-K ) THEN                                              SLAP........886400
         IL(M) = I                                                       SLAP........886500
         IU(M) = L                                                       SLAP........886600
         I = K                                                           SLAP........886700
         M = M+1                                                         SLAP........886800
      ELSE                                                               SLAP........886900
         ...
         M = M+1                                                         SLAP........887300
      ENDIF                                                              SLAP........887400
      GO TO 260                                                          SLAP........887500
C                                                                        SLAP........887600
C     Begin again on another portion of the unsorted array.              SLAP........887700
C                                                                        SLAP........887800
  255 M = M-1                                                            SLAP........887900
      IF( M.EQ.0 ) GO TO 300                                             SLAP........888000
      I = IL(M)                                                          SLAP........888100
      J = IU(M)                                                          SLAP........888200
  260 IF( J-I.GE.1 ) GO TO 225                                           SLAP........888300
      IF( I.EQ.J ) GO TO 255                                             SLAP........888400
      IF( I.EQ.1 ) GO TO 210                                             SLAP........888500
      I = I-1                                                            SLAP........888600
  265 I = I+1                                                            SLAP........888700
      IF( I.EQ.J ) GO TO 255                                             SLAP........888800
      IT = IA(I+1)                                                       SLAP........888900
      JT = JA(I+1)                                                       SLAP........889000
      TA =  A(I+1)                                                       SLAP........889100
      IF( IA(I).LE.IT ) GO TO 265                                        SLAP........889200
      K=I                                                                SLAP........889300
  270 IA(K+1) = IA(K)                                                    SLAP........889400
      JA(K+1) = JA(K)                                                    SLAP........889500
      A(K+1)  =  A(K)                                                    SLAP........889600
      K = K-1                                                            SLAP........889700
      IF( IT.LT.IA(K) ) GO TO 270                                        SLAP........889800
      IA(K+1) = IT                                                       SLAP........889900
      JA(K+1) = JT                                                       SLAP........890000
      A(K+1)  = TA                                                       SLAP........890100
      GO TO 265                                                          SLAP........890200
C                                                                        SLAP........890300
C     Clean up, if necessary.                                            SLAP........890400
C                                                                        SLAP........890500
  300 IF( KFLAG.LT.1 ) THEN                                              SLAP........890600
         DO 310 I=1,NN                                                   SLAP........890700
            IA(I) = -IA(I)                                               SLAP........890800
 310     CONTINUE                                                        SLAP........890900
      ENDIF                                                              SLAP........891000
      RETURN                                                             SLAP........891100
C------------- LAST LINE OF QS2I1D FOLLOWS ----------------------------  SLAP........891200
      END                                                                SLAP........891300
*DECK XERCNT                                                             SLAP........891400
      SUBROUTINE XERCNT (LIBRAR, SUBROU, MESSG, NERR, LEVEL, KONTRL)     SLAP........891500
C***BEGIN PROLOGUE  XERCNT                                               SLAP........891600
C***SUBSIDIARY                                                           SLAP........891700
C***PURPOSE  Allow user control over handling of errors.                 SLAP........891800
C***LIBRARY   SLATEC (XERROR)                                            SLAP........891900
C***CATEGORY  R3C                                                        SLAP........892000
C***TYPE      ALL (XERCNT-A)                                             SLAP........892100
C***KEYWORDS  ERROR, XERROR                                              SLAP........892200
C***AUTHOR  Jones, R. E., (SNLA)                                         SLAP........892300
C***DESCRIPTION                                                          SLAP........892400
C                                                                        SLAP........892500
C     Abstract                                                           SLAP........892600
C        Allows user control over handling of individual errors.         SLAP........892700
C        Just after each message is recorded, but before it is           SLAP........892800
C        processed any further (i.e., before it is printed or            SLAP........892900
C        a decision to abort is made), a call is made to XERCNT.         SLAP........893000
C        If the user has provided his own version of XERCNT, he          SLAP........893100
C        can then override the value of KONTROL used in processing       SLAP........893200
C        this message by redefining its value.                           SLAP........893300
C        KONTRL may be set to any value from -2 to 2.                    SLAP........893400
C        The meanings for KONTRL are the same as in XSETF, except        SLAP........893500
C        that the value of KONTRL changes only for this message.         SLAP........893600
C        If KONTRL is set to a value outside the range from -2 to 2,     SLAP........893700
C        it will be moved back into that range.                          SLAP........893800
C                                                                        SLAP........893900
C     Description of Parameters                                          SLAP........894000
C                                                                        SLAP........894100
C      --Input--                                                         SLAP........894200
C        LIBRAR - the library that the routine is in.                    SLAP........894300
C        SUBROU - the subroutine that XERMSG is being called from        SLAP........894400
C        MESSG  - the first 20 characters of the error message.          SLAP........894500
C        NERR   - same as in the call to XERMSG.                         SLAP........894600
C        LEVEL  - same as in the call to XERMSG.                         SLAP........894700
C        KONTRL - the current value of the control flag as set           SLAP........894800
C                 by a call to XSETF.                                    SLAP........894900
C                                                                        SLAP........895000
C      --Output--                                                        SLAP........895100
C        KONTRL - the new value of KONTRL.  If KONTRL is not             SLAP........895200
C                 defined, it will remain at its original value.         SLAP........895300
C                 This changed value of control affects only             SLAP........895400
C                 the current occurrence of the current message.         SLAP........895500
C                                                                        SLAP........895600
C***REFERENCES  R. E. Jones and D. K. Kahaner, XERROR, the SLATEC        SLAP........895700
C                 Error-handling Package, SAND82-0800, Sandia            SLAP........895800
C                 Laboratories, 1982.                                    SLAP........895900
C***ROUTINES CALLED  (NONE)                                              SLAP........896000
C***REVISION HISTORY  (YYMMDD)                                           SLAP........896100
C   790801  DATE WRITTEN                                                 SLAP........896200
C   861211  REVISION DATE from Version 3.2                               SLAP........896300
C   891214  Prologue converted to Version 4.0 format.  (BAB)             SLAP........896400
C   900206  Routine changed from user-callable to subsidiary.  (WRB)     SLAP........896500
C   900510  Changed calling sequence to include LIBRARY and SUBROUTINE   SLAP........896600
C           names, changed routine name from XERCTL to XERCNT.  (RWC)    SLAP........896700
C   920501  Reformatted the REFERENCES section.  (WRB)                   SLAP........896800
C***END PROLOGUE  XERCNT                                                 SLAP........896900
      CHARACTER*(*) LIBRAR, SUBROU, MESSG                                SLAP........897000
C***FIRST EXECUTABLE STATEMENT  XERCNT                                   SLAP........897100
C.....THE NEXT TWO NON-COMMENT LINES (ONE CONTINUED LINE) WERE ADDED     SLAP........897200
C        DURING INTEGRATION OF SLAP WITH SUTRA.  THEY ALLOW THE SOLUTION SLAP........897300
C        PROCESS TO CONTINUE IF THE IC FACTORIZATION FOR THE CG SOLVER   SLAP........897400
C        IS FUDGED.                                                      SLAP........897500
      IF ((LIBRAR.EQ.'SLATEC').AND.(SUBROU.EQ.'DSICCG').AND.             SLAP........897600
     1    (MESSG(1:20).EQ.'IC factorization bro')) KONTRL = 0            SLAP........897700
      RETURN                                                             SLAP........897800
      END                                                                SLAP........897900
*DECK XERHLT                                                             SLAP........898000
      SUBROUTINE XERHLT (MESSG)                                          SLAP........898100
C***BEGIN PROLOGUE  XERHLT                                               SLAP........898200
C***SUBSIDIARY                                                           SLAP........898300
C***PURPOSE  Abort program execution and print error message.            SLAP........898400
C***LIBRARY   SLATEC (XERROR)                                            SLAP........898500
C***CATEGORY  R3C                                                        SLAP........898600
C***TYPE      ALL (XERHLT-A)                                             SLAP........898700
C***KEYWORDS  ABORT PROGRAM EXECUTION, ERROR, XERROR                     SLAP........898800
C***AUTHOR  Jones, R. E., (SNLA)                                         SLAP........898900
C***DESCRIPTION                                                          SLAP........899000
C                                                                        SLAP........899100
C     Abstract                                                           SLAP........899200
C        ***Note*** machine dependent routine                            SLAP........899300
C        XERHLT aborts the execution of the program.                     SLAP........899400
C        The error message causing the abort is given in the calling     SLAP........899500
C        sequence, in case one needs it for printing on a dayfile,       SLAP........899600
C        for example.                                                    SLAP........899700
C                                                                        SLAP........899800
C     Description of Parameters                                          SLAP........899900
C        MESSG is as in XERMSG.                                          SLAP........900000
C                                                                        SLAP........900100
C***REFERENCES  R. E. Jones and D. K. Kahaner, XERROR, the SLATEC        SLAP........900200
C                 Error-handling Package, SAND82-0800, Sandia            SLAP........900300
C                 Laboratories, 1982.                                    SLAP........900400
C***ROUTINES CALLED  (NONE)                                              SLAP........900500
C***REVISION HISTORY  (YYMMDD)                                           SLAP........900600
C   790801  DATE WRITTEN                                                 SLAP........900700
C   861211  REVISION DATE from Version 3.2                               SLAP........900800
C   891214  Prologue converted to Version 4.0 format.  (BAB)             SLAP........900900
C   900206  Routine changed from user-callable to subsidiary.  (WRB)     SLAP........901000
C   900510  Changed calling sequence to delete length of character       SLAP........901100
C           and changed routine name from XERABT to XERHLT.  (RWC)       SLAP........901200
C   920501  Reformatted the REFERENCES section.  (WRB)                   SLAP........901300
C***END PROLOGUE  XERHLT                                                 SLAP........901400
      CHARACTER*(*) MESSG                                                SLAP........901500
C***FIRST EXECUTABLE STATEMENT  XERHLT                                   SLAP........901600
      STOP                                                               SLAP........901700
      END                                                                SLAP........901800
*DECK XERMSG                                                             SLAP........901900
      SUBROUTINE XERMSG (LIBRAR, SUBROU, MESSG, NERR, LEVEL)             SLAP........902000
C***BEGIN PROLOGUE  XERMSG                                               SLAP........902100
C***PURPOSE  Process error messages for SLATEC and other libraries.      SLAP........902200
C***LIBRARY   SLATEC (XERROR)                                            SLAP........902300
C***CATEGORY  R3C                                                        SLAP........902400
C***TYPE      ALL (XERMSG-A)                                             SLAP........902500
C***KEYWORDS  ERROR MESSAGE, XERROR                                      SLAP........902600
C***AUTHOR  Fong, Kirby, (NMFECC at LLNL)                                SLAP........902700
C***DESCRIPTION                                                          SLAP........902800
C                                                                        SLAP........902900
C   XERMSG processes a diagnostic message in a manner determined by the  SLAP........903000
C   value of LEVEL and the current value of the library error control    SLAP........903100
C   flag, KONTRL.  See subroutine XSETF for details.                     SLAP........903200
C                                                                        SLAP........903300
C    LIBRAR   A character constant (or character variable) with the name SLAP........903400
C             of the library.  This will be 'SLATEC' for the SLATEC      SLAP........903500
C             Common Math Library.  The error handling package is        SLAP........903600
C             general enough to be used by many libraries                SLAP........903700
C             simultaneously, so it is desirable for the routine that    SLAP........903800
C             detects and reports an error to identify the library name  SLAP........903900
C             as well as the routine name.                               SLAP........904000
C                                                                        SLAP........904100
C    SUBROU   A character constant (or character variable) with the name SLAP........904200
C             of the routine that detected the error.  Usually it is the SLAP........904300
C             name of the routine that is calling XERMSG.  There are     SLAP........904400
C             some instances where a user callable library routine calls SLAP........904500
C             lower level subsidiary routines where the error is         SLAP........904600
C             detected.  In such cases it may be more informative to     SLAP........904700
C             supply the name of the routine the user called rather than SLAP........904800
C             the name of the subsidiary routine that detected the       SLAP........904900
C             error.                                                     SLAP........905000
C                                                                        SLAP........905100
C    MESSG    A character constant (or character variable) with the text SLAP........905200
C             of the error or warning message.  In the example below,    SLAP........905300
C             the message is a character constant that contains a        SLAP........905400
C             generic message.                                           SLAP........905500
C                                                                        SLAP........905600
C                   CALL XERMSG ('SLATEC', 'MMPY',                       SLAP........905700
C                  *'THE ORDER OF THE MATRIX EXCEEDS THE ROW DIMENSION', SLAP........905800
C                  *3, 1)                                                SLAP........905900
C                                                                        SLAP........906000
C             It is possible (and is sometimes desirable) to generate a  SLAP........906100
C             specific message--e.g., one that contains actual numeric   SLAP........906200
C             values.  Specific numeric values can be converted into     SLAP........906300
C             character strings using formatted WRITE statements into    SLAP........906400
C             character variables.  This is called standard Fortran      SLAP........906500
C             internal file I/O and is exemplified in the first three    SLAP........906600
C             lines of the following example.  You can also catenate     SLAP........906700
C             substrings of characters to construct the error message.   SLAP........906800
C             Here is an example showing the use of both writing to      SLAP........906900
C             an internal file and catenating character strings.         SLAP........907000
C                                                                        SLAP........907100
C                   CHARACTER*5 CHARN, CHARL                             SLAP........907200
C                   WRITE (CHARN,10) N                                   SLAP........907300
C                   WRITE (CHARL,10) LDA                                 SLAP........907400
C                10 FORMAT(I5)                                           SLAP........907500
C                   CALL XERMSG ('SLATEC', 'MMPY', 'THE ORDER'//CHARN//  SLAP........907600
C                  *   ' OF THE MATRIX EXCEEDS ITS ROW DIMENSION OF'//   SLAP........907700
C                  *   CHARL, 3, 1)                                      SLAP........907800
C                                                                        SLAP........907900
C             There are two subtleties worth mentioning.  One is that    SLAP........908000
C             the // for character catenation is used to construct the   SLAP........908100
C             error message so that no single character constant is      SLAP........908200
C             continued to the next line.  This avoids confusion as to   SLAP........908300
C             whether there are trailing blanks at the end of the line.  SLAP........908400
C             The second is that by catenating the parts of the message  SLAP........908500
C             as an actual argument rather than encoding the entire      SLAP........908600
C             message into one large character variable, we avoid        SLAP........908700
C             having to know how long the message will be in order to    SLAP........908800
C             declare an adequate length for that large character        SLAP........908900
C             variable.  XERMSG calls XERPRN to print the message using  SLAP........909000
C             multiple lines if necessary.  If the message is very long, SLAP........909100
C             XERPRN will break it into pieces of 72 characters (as      SLAP........909200
C             requested by XERMSG) for printing on multiple lines.       SLAP........909300
C             Also, XERMSG asks XERPRN to prefix each line with ' *  '   SLAP........909400
C             so that the total line length could be 76 characters.      SLAP........909500
C             Note also that XERPRN scans the error message backwards    SLAP........909600
C             to ignore trailing blanks.  Another feature is that        SLAP........909700
C             the substring '$$' is treated as a new line sentinel       SLAP........909800
C             by XERPRN.  If you want to construct a multiline           SLAP........909900
C             message without having to count out multiples of 72        SLAP........910000
C             characters, just use '$$' as a separator.  '$$'            SLAP........910100
C             obviously must occur within 72 characters of the           SLAP........910200
C             start of each line to have its intended effect since       SLAP........910300
C             XERPRN is asked to wrap around at 72 characters in         SLAP........910400
C             addition to looking for '$$'.                              SLAP........910500
C                                                                        SLAP........910600
C    NERR     An integer value that is chosen by the library routine's   SLAP........910700
C             author.  It must be in the range -99 to 999 (three         SLAP........910800
C             printable digits).  Each distinct error should have its    SLAP........910900
C             own error number.  These error numbers should be described SLAP........911000
C             in the machine readable documentation for the routine.     SLAP........911100
C             The error numbers need be unique only within each routine, SLAP........911200
C             so it is reasonable for each routine to start enumerating  SLAP........911300
C             errors from 1 and proceeding to the next integer.          SLAP........911400
C                                                                        SLAP........911500
C    LEVEL    An integer value in the range 0 to 2 that indicates the    SLAP........911600
C             level (severity) of the error.  Their meanings are         SLAP........911700
C                                                                        SLAP........911800
C            -1  A warning message.  This is used if it is not clear     SLAP........911900
C                that there really is an error, but the user's attention SLAP........912000
C                may be needed.  An attempt is made to only print this   SLAP........912100
C                message once.                                           SLAP........912200
C                                                                        SLAP........912300
C             0  A warning message.  This is used if it is not clear     SLAP........912400
C                that there really is an error, but the user's attention SLAP........912500
C                may be needed.                                          SLAP........912600
C                                                                        SLAP........912700
C             1  A recoverable error.  This is used even if the error is SLAP........912800
C                so serious that the routine cannot return any useful    SLAP........912900
C                answer.  If the user has told the error package to      SLAP........913000
C                return after recoverable errors, then XERMSG will       SLAP........913100
C                return to the Library routine which can then return to  SLAP........913200
C                the user's routine.  The user may also permit the error SLAP........913300
C                package to terminate the program upon encountering a    SLAP........913400
C                recoverable error.                                      SLAP........913500
C                                                                        SLAP........913600
C             2  A fatal error.  XERMSG will not return to its caller    SLAP........913700
C                after it receives a fatal error.  This level should     SLAP........913800
C                hardly ever be used; it is much better to allow the     SLAP........913900
C                user a chance to recover.  An example of one of the few SLAP........914000
C                cases in which it is permissible to declare a level 2   SLAP........914100
C                error is a reverse communication Library routine that   SLAP........914200
C                is likely to be called repeatedly until it integrates   SLAP........914300
C                across some interval.  If there is a serious error in   SLAP........914400
C                the input such that another step cannot be taken and    SLAP........914500
C                the Library routine is called again without the input   SLAP........914600
C                error having been corrected by the caller, the Library  SLAP........914700
C                routine will probably be called forever with improper   SLAP........914800
C                input.  In this case, it is reasonable to declare the   SLAP........914900
C                error to be fatal.                                      SLAP........915000
C                                                                        SLAP........915100
C    Each of the arguments to XERMSG is input; none will be modified by  SLAP........915200
C    XERMSG.  A routine may make multiple calls to XERMSG with warning   SLAP........915300
C    level messages; however, after a call to XERMSG with a recoverable  SLAP........915400
C    error, the routine should return to the user.  Do not try to call   SLAP........915500
C    XERMSG with a second recoverable error after the first recoverable  SLAP........915600
C    error because the error package saves the error number.  The user   SLAP........915700
C    can retrieve this error number by calling another entry point in    SLAP........915800
C    the error handling package and then clear the error number when     SLAP........915900
C    recovering from the error.  Calling XERMSG in succession causes the SLAP........916000
C    old error number to be overwritten by the latest error number.      SLAP........916100
C    This is considered harmless for error numbers associated with       SLAP........916200
C    warning messages but must not be done for error numbers of serious  SLAP........916300
C    errors.  After a call to XERMSG with a recoverable error, the user  SLAP........916400
C    must be given a chance to call NUMXER or XERCLR to retrieve or      SLAP........916500
C    clear the error number.                                             SLAP........916600
C***REFERENCES  R. E. Jones and D. K. Kahaner, XERROR, the SLATEC        SLAP........916700
C                 Error-handling Package, SAND82-0800, Sandia            SLAP........916800
C                 Laboratories, 1982.                                    SLAP........916900
C***ROUTINES CALLED  FDUMP, J4SAVE, XERCNT, XERHLT, XERPRN, XERSVE       SLAP........917000
C***REVISION HISTORY  (YYMMDD)                                           SLAP........917100
C   880101  DATE WRITTEN                                                 SLAP........917200
C   880621  REVISED AS DIRECTED AT SLATEC CML MEETING OF FEBRUARY 1988.  SLAP........917300
C           THERE ARE TWO BASIC CHANGES.                                 SLAP........917400
C           1.  A NEW ROUTINE, XERPRN, IS USED INSTEAD OF XERPRT TO      SLAP........917500
C               PRINT MESSAGES.  THIS ROUTINE WILL BREAK LONG MESSAGES   SLAP........917600
C               INTO PIECES FOR PRINTING ON MULTIPLE LINES.  '$$' IS     SLAP........917700
C               ACCEPTED AS A NEW LINE SENTINEL.  A PREFIX CAN BE        SLAP........917800
C               ADDED TO EACH LINE TO BE PRINTED.  XERMSG USES EITHER    SLAP........917900
C               ' ***' OR ' *  ' AND LONG MESSAGES ARE BROKEN EVERY      SLAP........918000
C               72 CHARACTERS (AT MOST) SO THAT THE MAXIMUM LINE         SLAP........918100
C               LENGTH OUTPUT CAN NOW BE AS GREAT AS 76.                 SLAP........918200
C           2.  THE TEXT OF ALL MESSAGES IS NOW IN UPPER CASE SINCE THE  SLAP........918300
C               FORTRAN STANDARD DOCUMENT DOES NOT ADMIT THE EXISTENCE   SLAP........918400
C               OF LOWER CASE.                                           SLAP........918500
C   880708  REVISED AFTER THE SLATEC CML MEETING OF JUNE 29 AND 30.      SLAP........918600
C           THE PRINCIPAL CHANGES ARE                                    SLAP........918700
C           1.  CLARIFY COMMENTS IN THE PROLOGUES                        SLAP........918800
C           2.  RENAME XRPRNT TO XERPRN                                  SLAP........918900
C           3.  REWORK HANDLING OF '$$' IN XERPRN TO HANDLE BLANK LINES  SLAP........919000
C               SIMILAR TO THE WAY FORMAT STATEMENTS HANDLE THE /        SLAP........919100
C               CHARACTER FOR NEW RECORDS.                               SLAP........919200
C   890706  REVISED WITH THE HELP OF FRED FRITSCH AND REG CLEMENS TO     SLAP........919300
C           CLEAN UP THE CODING.                                         SLAP........919400
C   890721  REVISED TO USE NEW FEATURE IN XERPRN TO COUNT CHARACTERS IN  SLAP........919500
C           PREFIX.                                                      SLAP........919600
C   891013  REVISED TO CORRECT COMMENTS.                                 SLAP........919700
C   891214  Prologue converted to Version 4.0 format.  (WRB)             SLAP........919800
C   900510  Changed test on NERR to be -9999999 < NERR < 99999999, but   SLAP........919900
C           NERR .ne. 0, and on LEVEL to be -2 < LEVEL < 3.  Added       SLAP........920000
C           LEVEL=-1 logic, changed calls to XERSAV to XERSVE, and       SLAP........920100
C           XERCTL to XERCNT.  (RWC)                                     SLAP........920200
C   920501  Reformatted the REFERENCES section.  (WRB)                   SLAP........920300
C***END PROLOGUE  XERMSG                                                 SLAP........920400
      CHARACTER*(*) LIBRAR, SUBROU, MESSG                                SLAP........920500
      CHARACTER*8 XLIBR, XSUBR                                           SLAP........920600
      CHARACTER*72  TEMP                                                 SLAP........920700
      CHARACTER*20  LFIRST                                               SLAP........920800
C***FIRST EXECUTABLE STATEMENT  XERMSG                                   SLAP........920900
      LKNTRL = J4SAVE (2, 0, .FALSE.)                                    SLAP........921000
      MAXMES = J4SAVE (4, 0, .FALSE.)                                    SLAP........921100
C                                                                        SLAP........921200
C       LKNTRL IS A LOCAL COPY OF THE CONTROL FLAG KONTRL.               SLAP........921300
C       MAXMES IS THE MAXIMUM NUMBER OF TIMES ANY PARTICULAR MESSAGE     SLAP........921400
C          SHOULD BE PRINTED.                                            SLAP........921500
C                                                                        SLAP........921600
C       WE PRINT A FATAL ERROR MESSAGE AND TERMINATE FOR AN ERROR IN     SLAP........921700
C          CALLING XERMSG.  THE ERROR NUMBER SHOULD BE POSITIVE,         SLAP........921800
C          AND THE LEVEL SHOULD BE BETWEEN 0 AND 2.                      SLAP........921900
C                                                                        SLAP........922000
      IF (NERR.LT.-9999999 .OR. NERR.GT.99999999 .OR. NERR.EQ.0 .OR.     SLAP........922100
     *   LEVEL.LT.-1 .OR. LEVEL.GT.2) THEN                               SLAP........922200
         CALL XERPRN (' ***', -1, 'FATAL ERROR IN...$$ ' //              SLAP........922300
     *      'XERMSG -- INVALID ERROR NUMBER OR LEVEL$$ '//               SLAP........922400
     *      'JOB ABORT DUE TO FATAL ERROR.', 72)                         SLAP........922500
         CALL XERSVE (' ', ' ', ' ', 0, 0, 0, KDUMMY)                    SLAP........922600
         CALL XERHLT (' ***XERMSG -- INVALID INPUT')                     SLAP........922700
         RETURN                                                          SLAP........922800
      ENDIF                                                              SLAP........922900
C                                                                        SLAP........923000
C       RECORD THE MESSAGE.                                              SLAP........923100
C                                                                        SLAP........923200
      I = J4SAVE (1, NERR, .TRUE.)                                       SLAP........923300
      CALL XERSVE (LIBRAR, SUBROU, MESSG, 1, NERR, LEVEL, KOUNT)         SLAP........923400
C                                                                        SLAP........923500
C       HANDLE PRINT-ONCE WARNING MESSAGES.                              SLAP........923600
C                                                                        SLAP........923700
      IF (LEVEL.EQ.-1 .AND. KOUNT.GT.1) RETURN                           SLAP........923800
C                                                                        SLAP........923900
C       ALLOW TEMPORARY USER OVERRIDE OF THE CONTROL FLAG.               SLAP........924000
C                                                                        SLAP........924100
      XLIBR  = LIBRAR                                                    SLAP........924200
      XSUBR  = SUBROU                                                    SLAP........924300
      LFIRST = MESSG                                                     SLAP........924400
      LERR   = NERR                                                      SLAP........924500
      LLEVEL = LEVEL                                                     SLAP........924600
      CALL XERCNT (XLIBR, XSUBR, LFIRST, LERR, LLEVEL, LKNTRL)           SLAP........924700
C                                                                        SLAP........924800
      LKNTRL = MAX(-2, MIN(2,LKNTRL))                                    SLAP........924900
      MKNTRL = ABS(LKNTRL)                                               SLAP........925000
C                                                                        SLAP........925100
C       SKIP PRINTING IF THE CONTROL FLAG VALUE AS RESET IN XERCNT IS    SLAP........925200
C       ZERO AND THE ERROR IS NOT FATAL.                                 SLAP........925300
C                                                                        SLAP........925400
      IF (LEVEL.LT.2 .AND. LKNTRL.EQ.0) GO TO 30                         SLAP........925500
      IF (LEVEL.EQ.0 .AND. KOUNT.GT.MAXMES) GO TO 30                     SLAP........925600
      IF (LEVEL.EQ.1 .AND. KOUNT.GT.MAXMES .AND. MKNTRL.EQ.1) GO TO 30   SLAP........925700
      IF (LEVEL.EQ.2 .AND. KOUNT.GT.MAX(1,MAXMES)) GO TO 30              SLAP........925800
C                                                                        SLAP........925900
C       ANNOUNCE THE NAMES OF THE LIBRARY AND SUBROUTINE BY BUILDING A   SLAP........926000
C       MESSAGE IN CHARACTER VARIABLE TEMP (NOT EXCEEDING 66 CHARACTERS) SLAP........926100
C       AND SENDING IT OUT VIA XERPRN.  PRINT ONLY IF CONTROL FLAG       SLAP........926200
C       IS NOT ZERO.                                                     SLAP........926300
C                                                                        SLAP........926400
      IF (LKNTRL .NE. 0) THEN                                            SLAP........926500
         TEMP(1:21) = 'MESSAGE FROM ROUTINE '                            SLAP........926600
         I = MIN(LEN(SUBROU), 16)                                        SLAP........926700
         TEMP(22:21+I) = SUBROU(1:I)                                     SLAP........926800
         TEMP(22+I:33+I) = ' IN LIBRARY '                                SLAP........926900
         LTEMP = 33 + I                                                  SLAP........927000
         I = MIN(LEN(LIBRAR), 16)                                        SLAP........927100
         TEMP(LTEMP+1:LTEMP+I) = LIBRAR (1:I)                            SLAP........927200
         TEMP(LTEMP+I+1:LTEMP+I+1) = '.'                                 SLAP........927300
         LTEMP = LTEMP + I + 1                                           SLAP........927400
         CALL XERPRN (' ***', -1, TEMP(1:LTEMP), 72)                     SLAP........927500
      ENDIF                                                              SLAP........927600
C                                                                        SLAP........927700
C       IF LKNTRL IS POSITIVE, PRINT AN INTRODUCTORY LINE BEFORE         SLAP........927800
C       PRINTING THE MESSAGE.  THE INTRODUCTORY LINE TELLS THE CHOICE    SLAP........927900
C       FROM EACH OF THE FOLLOWING THREE OPTIONS.                        SLAP........928000
C       1.  LEVEL OF THE MESSAGE                                         SLAP........928100
C              'INFORMATIVE MESSAGE'                                     SLAP........928200
C              'POTENTIALLY RECOVERABLE ERROR'                           SLAP........928300
C              'FATAL ERROR'                                             SLAP........928400
C       2.  WHETHER CONTROL FLAG WILL ALLOW PROGRAM TO CONTINUE          SLAP........928500
C              'PROG CONTINUES'                                          SLAP........928600
C              'PROG ABORTED'                                            SLAP........928700
C       3.  WHETHER OR NOT A TRACEBACK WAS REQUESTED.  (THE TRACEBACK    SLAP........928800
C           MAY NOT BE IMPLEMENTED AT SOME SITES, SO THIS ONLY TELLS     SLAP........928900
C           WHAT WAS REQUESTED, NOT WHAT WAS DELIVERED.)                 SLAP........929000
C              'TRACEBACK REQUESTED'                                     SLAP........929100
C              'TRACEBACK NOT REQUESTED'                                 SLAP........929200
C       NOTICE THAT THE LINE INCLUDING FOUR PREFIX CHARACTERS WILL NOT   SLAP........929300
C       EXCEED 74 CHARACTERS.                                            SLAP........929400
C       WE SKIP THE NEXT BLOCK IF THE INTRODUCTORY LINE IS NOT NEEDED.   SLAP........929500
C                                                                        SLAP........929600
      IF (LKNTRL .GT. 0) THEN                                            SLAP........929700
C                                                                        SLAP........929800
C       THE FIRST PART OF THE MESSAGE TELLS ABOUT THE LEVEL.             SLAP........929900
C                                                                        SLAP........930000
         IF (LEVEL .LE. 0) THEN                                          SLAP........930100
            TEMP(1:20) = 'INFORMATIVE MESSAGE,'                          SLAP........930200
            LTEMP = 20                                                   SLAP........930300
         ELSEIF (LEVEL .EQ. 1) THEN                                      SLAP........930400
            TEMP(1:30) = 'POTENTIALLY RECOVERABLE ERROR,'                SLAP........930500
            LTEMP = 30                                                   SLAP........930600
         ELSE                                                            SLAP........930700
            TEMP(1:12) = 'FATAL ERROR,'                                  SLAP........930800
            LTEMP = 12                                                   SLAP........930900
         ENDIF                                                           SLAP........931000
C                                                                        SLAP........931100
C       THEN WHETHER THE PROGRAM WILL CONTINUE.                          SLAP........931200
C                                                                        SLAP........931300
         IF ((MKNTRL.EQ.2 .AND. LEVEL.GE.1) .OR.                         SLAP........931400
     *       (MKNTRL.EQ.1 .AND. LEVEL.EQ.2)) THEN                        SLAP........931500
            TEMP(LTEMP+1:LTEMP+14) = ' PROG ABORTED,'                    SLAP........931600
            LTEMP = LTEMP + 14                                           SLAP........931700
         ELSE                                                            SLAP........931800
            TEMP(LTEMP+1:LTEMP+16) = ' PROG CONTINUES,'                  SLAP........931900
            LTEMP = LTEMP + 16                                           SLAP........932000
         ENDIF                                                           SLAP........932100
C                                                                        SLAP........932200
C       FINALLY TELL WHETHER THERE SHOULD BE A TRACEBACK.                SLAP........932300
C                                                                        SLAP........932400
         IF (LKNTRL .GT. 0) THEN                                         SLAP........932500
            TEMP(LTEMP+1:LTEMP+20) = ' TRACEBACK REQUESTED'              SLAP........932600
            LTEMP = LTEMP + 20                                           SLAP........932700
         ELSE                                                            SLAP........932800
            TEMP(LTEMP+1:LTEMP+24) = ' TRACEBACK NOT REQUESTED'          SLAP........932900
            LTEMP = LTEMP + 24                                           SLAP........933000
         ENDIF                                                           SLAP........933100
         CALL XERPRN (' ***', -1, TEMP(1:LTEMP), 72)                     SLAP........933200
      ENDIF                                                              SLAP........933300
C                                                                        SLAP........933400
C       NOW SEND OUT THE MESSAGE.                                        SLAP........933500
C                                                                        SLAP........933600
      CALL XERPRN (' *  ', -1, MESSG, 72)                                SLAP........933700
C                                                                        SLAP........933800
C       IF LKNTRL IS POSITIVE, WRITE THE ERROR NUMBER AND REQUEST A      SLAP........933900
C          TRACEBACK.                                                    SLAP........934000
C                                                                        SLAP........934100
      IF (LKNTRL .GT. 0) THEN                                            SLAP........934200
         WRITE (TEMP, '(''ERROR NUMBER = '', I8)') NERR                  SLAP........934300
         DO 10 I=16,22                                                   SLAP........934400
            IF (TEMP(I:I) .NE. ' ') GO TO 20                             SLAP........934500
   10    CONTINUE                                                        SLAP........934600
C                                                                        SLAP........934700
   20    CALL XERPRN (' *  ', -1, TEMP(1:15) // TEMP(I:23), 72)          SLAP........934800
         CALL FDUMP                                                      SLAP........934900
      ENDIF                                                              SLAP........935000
C                                                                        SLAP........935100
C       IF LKNTRL IS NOT ZERO, PRINT A BLANK LINE AND AN END OF MESSAGE. SLAP........935200
C                                                                        SLAP........935300
      IF (LKNTRL .NE. 0) THEN                                            SLAP........935400
         CALL XERPRN (' *  ', -1, ' ', 72)                               SLAP........935500
         CALL XERPRN (' ***', -1, 'END OF MESSAGE', 72)                  SLAP........935600
         CALL XERPRN ('    ',  0, ' ', 72)                               SLAP........935700
      ENDIF                                                              SLAP........935800
C                                                                        SLAP........935900
C       IF THE ERROR IS NOT FATAL OR THE ERROR IS RECOVERABLE AND THE    SLAP........936000
C       CONTROL FLAG IS SET FOR RECOVERY, THEN RETURN.                   SLAP........936100
C                                                                        SLAP........936200
   30 IF (LEVEL.LE.0 .OR. (LEVEL.EQ.1 .AND. MKNTRL.LE.1)) RETURN         SLAP........936300
C                                                                        SLAP........936400
C       THE PROGRAM WILL BE STOPPED DUE TO AN UNRECOVERED ERROR OR A     SLAP........936500
C       FATAL ERROR.  PRINT THE REASON FOR THE ABORT AND THE ERROR       SLAP........936600
C       SUMMARY IF THE CONTROL FLAG AND THE MAXIMUM ERROR COUNT PERMIT.  SLAP........936700
C                                                                        SLAP........936800
      IF (LKNTRL.GT.0 .AND. KOUNT.LT.MAX(1,MAXMES)) THEN                 SLAP........936900
         IF (LEVEL .EQ. 1) THEN                                          SLAP........937000
            CALL XERPRN                                                  SLAP........937100
     *         (' ***', -1, 'JOB ABORT DUE TO UNRECOVERED ERROR.', 72)   SLAP........937200
         ELSE                                                            SLAP........937300
            CALL XERPRN(' ***', -1, 'JOB ABORT DUE TO FATAL ERROR.', 72) SLAP........937400
         ENDIF                                                           SLAP........937500
         CALL XERSVE (' ', ' ', ' ', -1, 0, 0, KDUMMY)                   SLAP........937600
         CALL XERHLT (' ')                                               SLAP........937700
      ELSE                                                               SLAP........937800
         CALL XERHLT (MESSG)                                             SLAP........937900
      ENDIF                                                              SLAP........938000
      RETURN                                                             SLAP........938100
      END                                                                SLAP........938200
*DECK XERPRN                                                             SLAP........938300
      SUBROUTINE XERPRN (PREFIX, NPREF, MESSG, NWRAP)                    SLAP........938400
C***BEGIN PROLOGUE  XERPRN                                               SLAP........938500
C***SUBSIDIARY                                                           SLAP........938600
C***PURPOSE  Print error messages processed by XERMSG.                   SLAP........938700
C***LIBRARY   SLATEC (XERROR)                                            SLAP........938800
C***CATEGORY  R3C                                                        SLAP........938900
C***TYPE      ALL (XERPRN-A)                                             SLAP........939000
C***KEYWORDS  ERROR MESSAGES, PRINTING, XERROR                           SLAP........939100
C***AUTHOR  Fong, Kirby, (NMFECC at LLNL)                                SLAP........939200
C***DESCRIPTION                                                          SLAP........939300
C                                                                        SLAP........939400
C This routine sends one or more lines to each of the (up to five)       SLAP........939500
C logical units to which error messages are to be sent.  This routine    SLAP........939600
C is called several times by XERMSG, sometimes with a single line to     SLAP........939700
C print and sometimes with a (potentially very long) message that may    SLAP........939800
C wrap around into multiple lines.                                       SLAP........939900
C                                                                        SLAP........940000
C PREFIX  Input argument of type CHARACTER.  This argument contains      SLAP........940100
C         characters to be put at the beginning of each line before      SLAP........940200
C         the body of the message.  No more than 16 characters of        SLAP........940300
C         PREFIX will be used.                                           SLAP........940400
C                                                                        SLAP........940500
C NPREF   Input argument of type INTEGER.  This argument is the number   SLAP........940600
C         of characters to use from PREFIX.  If it is negative, the      SLAP........940700
C         intrinsic function LEN is used to determine its length.  If    SLAP........940800
C         it is zero, PREFIX is not used.  If it exceeds 16 or if        SLAP........940900
C         LEN(PREFIX) exceeds 16, only the first 16 characters will be   SLAP........941000
C         used.  If NPREF is positive and the length of PREFIX is less   SLAP........941100
C         than NPREF, a copy of PREFIX extended with blanks to length    SLAP........941200
C         NPREF will be used.                                            SLAP........941300
C                                                                        SLAP........941400
C MESSG   Input argument of type CHARACTER.  This is the text of a       SLAP........941500
C         message to be printed.  If it is a long message, it will be    SLAP........941600
C         broken into pieces for printing on multiple lines.  Each line  SLAP........941700
C         will start with the appropriate prefix and be followed by a    SLAP........941800
C         piece of the message.  NWRAP is the number of characters per   SLAP........941900
C         piece; that is, after each NWRAP characters, we break and      SLAP........942000
C         start a new line.  In addition the characters '$$' embedded    SLAP........942100
C         in MESSG are a sentinel for a new line.  The counting of       SLAP........942200
C         characters up to NWRAP starts over for each new line.  The     SLAP........942300
C         value of NWRAP typically used by XERMSG is 72 since many       SLAP........942400
C         older error messages in the SLATEC Library are laid out to     SLAP........942500
C         rely on wrap-around every 72 characters.                       SLAP........942600
C                                                                        SLAP........942700
C NWRAP   Input argument of type INTEGER.  This gives the maximum size   SLAP........942800
C         piece into which to break MESSG for printing on multiple       SLAP........942900
C         lines.  An embedded '$$' ends a line, and the count restarts   SLAP........943000
C         at the following character.  If a line break does not occur    SLAP........943100
C         on a blank (it would split a word) that word is moved to the   SLAP........943200
C         next line.  Values of NWRAP less than 16 will be treated as    SLAP........943300
C         16.  Values of NWRAP greater than 132 will be treated as 132.  SLAP........943400
C         The actual line length will be NPREF + NWRAP after NPREF has   SLAP........943500
C         been adjusted to fall between 0 and 16 and NWRAP has been      SLAP........943600
C         adjusted to fall between 16 and 132.                           SLAP........943700
C                                                                        SLAP........943800
C***REFERENCES  R. E. Jones and D. K. Kahaner, XERROR, the SLATEC        SLAP........943900
C                 Error-handling Package, SAND82-0800, Sandia            SLAP........944000
C                 Laboratories, 1982.                                    SLAP........944100
C***ROUTINES CALLED  I1MACH, XGETUA                                      SLAP........944200
C***REVISION HISTORY  (YYMMDD)                                           SLAP........944300
C   880621  DATE WRITTEN                                                 SLAP........944400
C   880708  REVISED AFTER THE SLATEC CML SUBCOMMITTEE MEETING OF         SLAP........944500
C           JUNE 29 AND 30 TO CHANGE THE NAME TO XERPRN AND TO REWORK    SLAP........944600
C           THE HANDLING OF THE NEW LINE SENTINEL TO BEHAVE LIKE THE     SLAP........944700
C           SLASH CHARACTER IN FORMAT STATEMENTS.                        SLAP........944800
C   890706  REVISED WITH THE HELP OF FRED FRITSCH AND REG CLEMENS TO     SLAP........944900
C           STREAMLINE THE CODING AND FIX A BUG THAT CAUSED EXTRA BLANK  SLAP........945000
C           LINES TO BE PRINTED.                                         SLAP........945100
C   890721  REVISED TO ADD A NEW FEATURE.  A NEGATIVE VALUE OF NPREF     SLAP........945200
C           CAUSES LEN(PREFIX) TO BE USED AS THE LENGTH.                 SLAP........945300
C   891013  REVISED TO CORRECT ERROR IN CALCULATING PREFIX LENGTH.       SLAP........945400
C   891214  Prologue converted to Version 4.0 format.  (WRB)             SLAP........945500
C   900510  Added code to break messages between words.  (RWC)           SLAP........945600
C   920501  Reformatted the REFERENCES section.  (WRB)                   SLAP........945700
C***END PROLOGUE  XERPRN                                                 SLAP........945800
      CHARACTER*(*) PREFIX, MESSG                                        SLAP........945900
      INTEGER NPREF, NWRAP                                               SLAP........946000
      CHARACTER*148 CBUFF                                                SLAP........946100
      INTEGER IU(5), NUNIT                                               SLAP........946200
      CHARACTER*2 NEWLIN                                                 SLAP........946300
      PARAMETER (NEWLIN = '$$')                                          SLAP........946400
C***FIRST EXECUTABLE STATEMENT  XERPRN                                   SLAP........946500
      CALL XGETUA(IU,NUNIT)                                              SLAP........946600
C                                                                        SLAP........946700
C       A ZERO VALUE FOR A LOGICAL UNIT NUMBER MEANS TO USE THE STANDARD SLAP........946800
C       ERROR MESSAGE UNIT INSTEAD.  I1MACH(4) RETRIEVES THE STANDARD    SLAP........946900
C       ERROR MESSAGE UNIT.                                              SLAP........947000
C                                                                        SLAP........947100
      N = I1MACH(4)                                                      SLAP........947200
      DO 10 I=1,NUNIT                                                    SLAP........947300
         IF (IU(I) .EQ. 0) IU(I) = N                                     SLAP........947400
   10 CONTINUE                                                           SLAP........947500
C                                                                        SLAP........947600
C       LPREF IS THE LENGTH OF THE PREFIX.  THE PREFIX IS PLACED AT THE  SLAP........947700
C       BEGINNING OF CBUFF, THE CHARACTER BUFFER, AND KEPT THERE DURING  SLAP........947800
C       THE REST OF THIS ROUTINE.                                        SLAP........947900
C                                                                        SLAP........948000
      IF ( NPREF .LT. 0 ) THEN                                           SLAP........948100
         LPREF = LEN(PREFIX)                                             SLAP........948200
      ELSE                                                               SLAP........948300
         LPREF = NPREF                                                   SLAP........948400
      ENDIF                                                              SLAP........948500
      LPREF = MIN(16, LPREF)                                             SLAP........948600
      IF (LPREF .NE. 0) CBUFF(1:LPREF) = PREFIX                          SLAP........948700
C                                                                        SLAP........948800
C       LWRAP IS THE MAXIMUM NUMBER OF CHARACTERS WE WANT TO TAKE AT ONE SLAP........948900
C       TIME FROM MESSG TO PRINT ON ONE LINE.                            SLAP........949000
C                                                                        SLAP........949100
      LWRAP = MAX(16, MIN(132, NWRAP))                                   SLAP........949200
C                                                                        SLAP........949300
C       SET LENMSG TO THE LENGTH OF MESSG, IGNORE ANY TRAILING BLANKS.   SLAP........949400
C                                                                        SLAP........949500
      LENMSG = LEN(MESSG)                                                SLAP........949600
      N = LENMSG                                                         SLAP........949700
      DO 20 I=1,N                                                        SLAP........949800
         IF (MESSG(LENMSG:LENMSG) .NE. ' ') GO TO 30                     SLAP........949900
         LENMSG = LENMSG - 1                                             SLAP........950000
   20 CONTINUE                                                           SLAP........950100
   30 CONTINUE                                                           SLAP........950200
C                                                                        SLAP........950300
C       IF THE MESSAGE IS ALL BLANKS, THEN PRINT ONE BLANK LINE.         SLAP........950400
C                                                                        SLAP........950500
      IF (LENMSG .EQ. 0) THEN                                            SLAP........950600
         CBUFF(LPREF+1:LPREF+1) = ' '                                    SLAP........950700
         DO 40 I=1,NUNIT                                                 SLAP........950800
            WRITE(IU(I), '(A)') CBUFF(1:LPREF+1)                         SLAP........950900
   40    CONTINUE                                                        SLAP........951000
         RETURN                                                          SLAP........951100
      ENDIF                                                              SLAP........951200
C                                                                        SLAP........951300
C       SET NEXTC TO THE POSITION IN MESSG WHERE THE NEXT SUBSTRING      SLAP........951400
C       STARTS.  FROM THIS POSITION WE SCAN FOR THE NEW LINE SENTINEL.   SLAP........951500
C       WHEN NEXTC EXCEEDS LENMSG, THERE IS NO MORE TO PRINT.            SLAP........951600
C       WE LOOP BACK TO LABEL 50 UNTIL ALL PIECES HAVE BEEN PRINTED.     SLAP........951700
C                                                                        SLAP........951800
C       WE LOOK FOR THE NEXT OCCURRENCE OF THE NEW LINE SENTINEL.  THE   SLAP........951900
C       INDEX INTRINSIC FUNCTION RETURNS ZERO IF THERE IS NO OCCURRENCE  SLAP........952000
C       OR IF THE LENGTH OF THE FIRST ARGUMENT IS LESS THAN THE LENGTH   SLAP........952100
C       OF THE SECOND ARGUMENT.                                          SLAP........952200
C                                                                        SLAP........952300
C       THERE ARE SEVERAL CASES WHICH SHOULD BE CHECKED FOR IN THE       SLAP........952400
C       FOLLOWING ORDER.  WE ARE ATTEMPTING TO SET LPIECE TO THE NUMBER  SLAP........952500
C       OF CHARACTERS THAT SHOULD BE TAKEN FROM MESSG STARTING AT        SLAP........952600
C       POSITION NEXTC.                                                  SLAP........952700
C                                                                        SLAP........952800
C       LPIECE .EQ. 0   THE NEW LINE SENTINEL DOES NOT OCCUR IN THE      SLAP........952900
C                       REMAINDER OF THE CHARACTER STRING.  LPIECE       SLAP........953000
C                       SHOULD BE SET TO LWRAP OR LENMSG+1-NEXTC,        SLAP........953100
C                       WHICHEVER IS LESS.                               SLAP........953200
C                                                                        SLAP........953300
C       LPIECE .EQ. 1   THE NEW LINE SENTINEL STARTS AT MESSG(NEXTC:     SLAP........953400
C                       NEXTC).  LPIECE IS EFFECTIVELY ZERO, AND WE      SLAP........953500
C                       PRINT NOTHING TO AVOID PRODUCING UNNECESSARY     SLAP........953600
C                       BLANK LINES.  THIS TAKES CARE OF THE SITUATION   SLAP........953700
C                       WHERE THE LIBRARY ROUTINE HAS A MESSAGE OF       SLAP........953800
C                       EXACTLY 72 CHARACTERS FOLLOWED BY A NEW LINE     SLAP........953900
C                       SENTINEL FOLLOWED BY MORE CHARACTERS.  NEXTC     SLAP........954000
C                       SHOULD BE INCREMENTED BY 2.                      SLAP........954100
C                                                                        SLAP........954200
C       LPIECE .GT. LWRAP+1  REDUCE LPIECE TO LWRAP.                     SLAP........954300
C                                                                        SLAP........954400
C       ELSE            THIS LAST CASE MEANS 2 .LE. LPIECE .LE. LWRAP+1  SLAP........954500
C                       RESET LPIECE = LPIECE-1.  NOTE THAT THIS         SLAP........954600
C                       PROPERLY HANDLES THE END CASE WHERE LPIECE .EQ.  SLAP........954700
C                       LWRAP+1.  THAT IS, THE SENTINEL FALLS EXACTLY    SLAP........954800
C                       AT THE END OF A LINE.                            SLAP........954900
C                                                                        SLAP........955000
      NEXTC = 1                                                          SLAP........955100
   50 LPIECE = INDEX(MESSG(NEXTC:LENMSG), NEWLIN)                        SLAP........955200
      IF (LPIECE .EQ. 0) THEN                                            SLAP........955300
C                                                                        SLAP........955400
C       THERE WAS NO NEW LINE SENTINEL FOUND.                            SLAP........955500
C                                                                        SLAP........955600
         IDELTA = 0                                                      SLAP........955700
         LPIECE = MIN(LWRAP, LENMSG+1-NEXTC)                             SLAP........955800
         IF (LPIECE .LT. LENMSG+1-NEXTC) THEN                            SLAP........955900
            DO 52 I=LPIECE+1,2,-1                                        SLAP........956000
               IF (MESSG(NEXTC+I-1:NEXTC+I-1) .EQ. ' ') THEN             SLAP........956100
                  LPIECE = I-1                                           SLAP........956200
                  IDELTA = 1                                             SLAP........956300
                  GOTO 54                                                SLAP........956400
               ENDIF                                                     SLAP........956500
   52       CONTINUE                                                     SLAP........956600
         ENDIF                                                           SLAP........956700
   54    CBUFF(LPREF+1:LPREF+LPIECE) = MESSG(NEXTC:NEXTC+LPIECE-1)       SLAP........956800
         NEXTC = NEXTC + LPIECE + IDELTA                                 SLAP........956900
      ELSEIF (LPIECE .EQ. 1) THEN                                        SLAP........957000
C                                                                        SLAP........957100
C       WE HAVE A NEW LINE SENTINEL AT MESSG(NEXTC:NEXTC+1).             SLAP........957200
C       DON'T PRINT A BLANK LINE.                                        SLAP........957300
C                                                                        SLAP........957400
         NEXTC = NEXTC + 2                                               SLAP........957500
         GO TO 50                                                        SLAP........957600
      ELSEIF (LPIECE .GT. LWRAP+1) THEN                                  SLAP........957700
C                                                                        SLAP........957800
C       LPIECE SHOULD BE SET DOWN TO LWRAP.                              SLAP........957900
C                                                                        SLAP........958000
         IDELTA = 0                                                      SLAP........958100
         LPIECE = LWRAP                                                  SLAP........958200
         DO 56 I=LPIECE+1,2,-1                                           SLAP........958300
            IF (MESSG(NEXTC+I-1:NEXTC+I-1) .EQ. ' ') THEN                SLAP........958400
               LPIECE = I-1                                              SLAP........958500
               IDELTA = 1                                                SLAP........958600
               GOTO 58                                                   SLAP........958700
            ENDIF                                                        SLAP........958800
   56    CONTINUE                                                        SLAP........958900
   58    CBUFF(LPREF+1:LPREF+LPIECE) = MESSG(NEXTC:NEXTC+LPIECE-1)       SLAP........959000
         NEXTC = NEXTC + LPIECE + IDELTA                                 SLAP........959100
      ELSE                                                               SLAP........959200
C                                                                        SLAP........959300
C       IF WE ARRIVE HERE, IT MEANS 2 .LE. LPIECE .LE. LWRAP+1.          SLAP........959400
C       WE SHOULD DECREMENT LPIECE BY ONE.                               SLAP........959500
C                                                                        SLAP........959600
         LPIECE = LPIECE - 1                                             SLAP........959700
         CBUFF(LPREF+1:LPREF+LPIECE) = MESSG(NEXTC:NEXTC+LPIECE-1)       SLAP........959800
         NEXTC  = NEXTC + LPIECE + 2                                     SLAP........959900
      ENDIF                                                              SLAP........960000
C                                                                        SLAP........960100
C       PRINT                                                            SLAP........960200
C                                                                        SLAP........960300
      DO 60 I=1,NUNIT                                                    SLAP........960400
         WRITE(IU(I), '(A)') CBUFF(1:LPREF+LPIECE)                       SLAP........960500
   60 CONTINUE                                                           SLAP........960600
C                                                                        SLAP........960700
      IF (NEXTC .LE. LENMSG) GO TO 50                                    SLAP........960800
      RETURN                                                             SLAP........960900
      END                                                                SLAP........961000
*DECK XERSVE                                                             SLAP........961100
      SUBROUTINE XERSVE (LIBRAR, SUBROU, MESSG, KFLAG, NERR, LEVEL,      SLAP........961200
     +   ICOUNT)                                                         SLAP........961300
C***BEGIN PROLOGUE  XERSVE                                               SLAP........961400
C***SUBSIDIARY                                                           SLAP........961500
C***PURPOSE  Record that an error has occurred.                          SLAP........961600
C***LIBRARY   SLATEC (XERROR)                                            SLAP........961700
C***CATEGORY  R3                                                         SLAP........961800
C***TYPE      ALL (XERSVE-A)                                             SLAP........961900
C***KEYWORDS  ERROR, XERROR                                              SLAP........962000
C***AUTHOR  Jones, R. E., (SNLA)                                         SLAP........962100
C***DESCRIPTION                                                          SLAP........962200
C                                                                        SLAP........962300
C *Usage:                                                                SLAP........962400
C                                                                        SLAP........962500
C        INTEGER  KFLAG, NERR, LEVEL, ICOUNT                             SLAP........962600
C        CHARACTER * (len) LIBRAR, SUBROU, MESSG                         SLAP........962700
C                                                                        SLAP........962800
C        CALL XERSVE (LIBRAR, SUBROU, MESSG, KFLAG, NERR, LEVEL, ICOUNT) SLAP........962900
C                                                                        SLAP........963000
C *Arguments:                                                            SLAP........963100
C                                                                        SLAP........963200
C        LIBRAR :IN    is the library that the message is from.          SLAP........963300
C        SUBROU :IN    is the subroutine that the message is from.       SLAP........963400
C        MESSG  :IN    is the message to be saved.                       SLAP........963500
C        KFLAG  :IN    indicates the action to be performed.             SLAP........963600
C                      when KFLAG > 0, the message in MESSG is saved.    SLAP........963700
C                      when KFLAG=0 the tables will be dumped and        SLAP........963800
C                      cleared.                                          SLAP........963900
C                      when KFLAG < 0, the tables will be dumped and     SLAP........964000
C                      not cleared.                                      SLAP........964100
C        NERR   :IN    is the error number.                              SLAP........964200
C        LEVEL  :IN    is the error severity.                            SLAP........964300
C        ICOUNT :OUT   the number of times this message has been seen,   SLAP........964400
C                      or zero if the table has overflowed and does not  SLAP........964500
C                      contain this message specifically.  When KFLAG=0, SLAP........964600
C                      ICOUNT will not be altered.                       SLAP........964700
C                                                                        SLAP........964800
C *Description:                                                          SLAP........964900
C                                                                        SLAP........965000
C   Record that this error occurred and possibly dump and clear the      SLAP........965100
C   tables.                                                              SLAP........965200
C                                                                        SLAP........965300
C***REFERENCES  R. E. Jones and D. K. Kahaner, XERROR, the SLATEC        SLAP........965400
C                 Error-handling Package, SAND82-0800, Sandia            SLAP........965500
C                 Laboratories, 1982.                                    SLAP........965600
C***ROUTINES CALLED  I1MACH, XGETUA                                      SLAP........965700
C***REVISION HISTORY  (YYMMDD)                                           SLAP........965800
C   800319  DATE WRITTEN                                                 SLAP........965900
C   861211  REVISION DATE from Version 3.2                               SLAP........966000
C   891214  Prologue converted to Version 4.0 format.  (BAB)             SLAP........966100
C   900413  Routine modified to remove reference to KFLAG.  (WRB)        SLAP........966200
C   900510  Changed to add LIBRARY NAME and SUBROUTINE to calling        SLAP........966300
C           sequence, use IF-THEN-ELSE, make number of saved entries     SLAP........966400
C           easily changeable, changed routine name from XERSAV to       SLAP........966500
C           XERSVE.  (RWC)                                               SLAP........966600
C   910626  Added LIBTAB and SUBTAB to SAVE statement.  (BKS)            SLAP........966700
C   920501  Reformatted the REFERENCES section.  (WRB)                   SLAP........966800
C***END PROLOGUE  XERSVE                                                 SLAP........966900
      PARAMETER (LENTAB=10)                                              SLAP........967000
      INTEGER LUN(5)                                                     SLAP........967100
      CHARACTER*(*) LIBRAR, SUBROU, MESSG                                SLAP........967200
      CHARACTER*8  LIBTAB(LENTAB), SUBTAB(LENTAB), LIB, SUB              SLAP........967300
      CHARACTER*20 MESTAB(LENTAB), MES                                   SLAP........967400
      DIMENSION NERTAB(LENTAB), LEVTAB(LENTAB), KOUNT(LENTAB)            SLAP........967500
      SAVE LIBTAB, SUBTAB, MESTAB, NERTAB, LEVTAB, KOUNT, KOUNTX, NMSG   SLAP........967600
      DATA KOUNTX/0/, NMSG/0/                                            SLAP........967700
C***FIRST EXECUTABLE STATEMENT  XERSVE                                   SLAP........967800
C                                                                        SLAP........967900
      IF (KFLAG.LE.0) THEN                                               SLAP........968000
C                                                                        SLAP........968100
C        Dump the table.                                                 SLAP........968200
C                                                                        SLAP........968300
         IF (NMSG.EQ.0) RETURN                                           SLAP........968400
C                                                                        SLAP........968500
C        Print to each unit.                                             SLAP........968600
C                                                                        SLAP........968700
         CALL XGETUA (LUN, NUNIT)                                        SLAP........968800
         DO 20 KUNIT = 1,NUNIT                                           SLAP........968900
            IUNIT = LUN(KUNIT)                                           SLAP........969000
            IF (IUNIT.EQ.0) IUNIT = I1MACH(4)                            SLAP........969100
C                                                                        SLAP........969200
C           Print the table header.                                      SLAP........969300
C                                                                        SLAP........969400
            WRITE (IUNIT,9000)                                           SLAP........969500
C                                                                        SLAP........969600
C           Print body of table.                                         SLAP........969700
C                                                                        SLAP........969800
            DO 10 I = 1,NMSG                                             SLAP........969900
               WRITE (IUNIT,9010) LIBTAB(I), SUBTAB(I), MESTAB(I),       SLAP........970000
     *            NERTAB(I),LEVTAB(I),KOUNT(I)                           SLAP........970100
   10       CONTINUE                                                     SLAP........970200
C                                                                        SLAP........970300
C           Print number of other errors.                                SLAP........970400
C                                                                        SLAP........970500
            IF (KOUNTX.NE.0) WRITE (IUNIT,9020) KOUNTX                   SLAP........970600
            WRITE (IUNIT,9030)                                           SLAP........970700
   20    CONTINUE                                                        SLAP........970800
C                                                                        SLAP........970900
C        Clear the error tables.                                         SLAP........971000
C                                                                        SLAP........971100
         IF (KFLAG.EQ.0) THEN                                            SLAP........971200
            NMSG = 0                                                     SLAP........971300
            KOUNTX = 0                                                   SLAP........971400
         ENDIF                                                           SLAP........971500
      ELSE                                                               SLAP........971600
C                                                                        SLAP........971700
C        PROCESS A MESSAGE...                                            SLAP........971800
C        SEARCH FOR THIS MESSG, OR ELSE AN EMPTY SLOT FOR THIS MESSG,    SLAP........971900
C        OR ELSE DETERMINE THAT THE ERROR TABLE IS FULL.                 SLAP........972000
C                                                                        SLAP........972100
         LIB = LIBRAR                                                    SLAP........972200
         SUB = SUBROU                                                    SLAP........972300
         MES = MESSG                                                     SLAP........972400
         DO 30 I = 1,NMSG                                                SLAP........972500
            IF (LIB.EQ.LIBTAB(I) .AND. SUB.EQ.SUBTAB(I) .AND.            SLAP........972600
     *         MES.EQ.MESTAB(I) .AND. NERR.EQ.NERTAB(I) .AND.            SLAP........972700
     *         LEVEL.EQ.LEVTAB(I)) THEN                                  SLAP........972800
                  KOUNT(I) = KOUNT(I) + 1                                SLAP........972900
                  ICOUNT = KOUNT(I)                                      SLAP........973000
                  RETURN                                                 SLAP........973100
            ENDIF                                                        SLAP........973200
   30    CONTINUE                                                        SLAP........973300
C                                                                        SLAP........973400
         IF (NMSG.LT.LENTAB) THEN                                        SLAP........973500
C                                                                        SLAP........973600
C           Empty slot found for new message.                            SLAP........973700
C                                                                        SLAP........973800
            NMSG = NMSG + 1                                              SLAP........973900
            LIBTAB(I) = LIB                                              SLAP........974000
            SUBTAB(I) = SUB                                              SLAP........974100
            MESTAB(I) = MES                                              SLAP........974200
            NERTAB(I) = NERR                                             SLAP........974300
            LEVTAB(I) = LEVEL                                            SLAP........974400
            KOUNT (I) = 1                                                SLAP........974500
            ICOUNT    = 1                                                SLAP........974600
         ELSE                                                            SLAP........974700
C                                                                        SLAP........974800
C           Table is full.                                               SLAP........974900
C                                                                        SLAP........975000
            KOUNTX = KOUNTX+1                                            SLAP........975100
            ICOUNT = 0                                                   SLAP........975200
         ENDIF                                                           SLAP........975300
      ENDIF                                                              SLAP........975400
      RETURN                                                             SLAP........975500
C                                                                        SLAP........975600
C     Formats.                                                           SLAP........975700
C                                                                        SLAP........975800
 9000 FORMAT ('0          ERROR MESSAGE SUMMARY' /                       SLAP........975900
     +   ' LIBRARY    SUBROUTINE MESSAGE START             NERR',        SLAP........976000
     +   '     LEVEL     COUNT')                                         SLAP........976100
 9010 FORMAT (1X,A,3X,A,3X,A,3I10)                                       SLAP........976200
 9020 FORMAT ('0OTHER ERRORS NOT INDIVIDUALLY TABULATED = ', I10)        SLAP........976300
 9030 FORMAT (1X)                                                        SLAP........976400
      END                                                                SLAP........976500
*DECK XGETUA                                                             SLAP........976600
      SUBROUTINE XGETUA (IUNITA, N)                                      SLAP........976700
C***BEGIN PROLOGUE  XGETUA                                               SLAP........976800
C***PURPOSE  Return unit number(s) to which error messages are being     SLAP........976900
C            sent.                                                       SLAP........977000
C***LIBRARY   SLATEC (XERROR)                                            SLAP........977100
C***CATEGORY  R3C                                                        SLAP........977200
C***TYPE      ALL (XGETUA-A)                                             SLAP........977300
C***KEYWORDS  ERROR, XERROR                                              SLAP........977400
C***AUTHOR  Jones, R. E., (SNLA)                                         SLAP........977500
C***DESCRIPTION                                                          SLAP........977600
C                                                                        SLAP........977700
C     Abstract                                                           SLAP........977800
C        XGETUA may be called to determine the unit number or numbers    SLAP........977900
C        to which error messages are being sent.                         SLAP........978000
C        These unit numbers may have been set by a call to XSETUN,       SLAP........978100
C        or a call to XSETUA, or may be a default value.                 SLAP........978200
C                                                                        SLAP........978300
C     Description of Parameters                                          SLAP........978400
C      --Output--                                                        SLAP........978500
C        IUNIT - an array of one to five unit numbers, depending         SLAP........978600
C                on the value of N.  A value of zero refers to the       SLAP........978700
C                default unit, as defined by the I1MACH machine          SLAP........978800
C                constant routine.  Only IUNIT(1),...,IUNIT(N) are       SLAP........978900
C                defined by XGETUA.  The values of IUNIT(N+1),...,       SLAP........979000
C                IUNIT(5) are not defined (for N .LT. 5) or altered      SLAP........979100
C                in any way by XGETUA.                                   SLAP........979200
C        N     - the number of units to which copies of the              SLAP........979300
C                error messages are being sent.  N will be in the        SLAP........979400
C                range from 1 to 5.                                      SLAP........979500
C                                                                        SLAP........979600
C***REFERENCES  R. E. Jones and D. K. Kahaner, XERROR, the SLATEC        SLAP........979700
C                 Error-handling Package, SAND82-0800, Sandia            SLAP........979800
C                 Laboratories, 1982.                                    SLAP........979900
C***ROUTINES CALLED  J4SAVE                                              SLAP........980000
C***REVISION HISTORY  (YYMMDD)                                           SLAP........980100
C   790801  DATE WRITTEN                                                 SLAP........980200
C   861211  REVISION DATE from Version 3.2                               SLAP........980300
C   891214  Prologue converted to Version 4.0 format.  (BAB)             SLAP........980400
C   920501  Reformatted the REFERENCES section.  (WRB)                   SLAP........980500
C***END PROLOGUE  XGETUA                                                 SLAP........980600
      DIMENSION IUNITA(5)                                                SLAP........980700
C***FIRST EXECUTABLE STATEMENT  XGETUA                                   SLAP........980800
      N = J4SAVE(5,0,.FALSE.)                                            SLAP........980900
      DO 30 I=1,N                                                        SLAP........981000
         INDEX = I+4                                                     SLAP........981100
         IF (I.EQ.1) INDEX = 3                                           SLAP........981200
         IUNITA(I) = J4SAVE(INDEX,0,.FALSE.)                             SLAP........981300
   30 CONTINUE                                                           SLAP........981400
      RETURN                                                             SLAP........981500
      END                                                                SLAP........981600
